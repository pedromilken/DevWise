...
LANG.de = {
 ...
 "ui": {
  ...
  "map": "Wissenslandkarte",
  "sbcH": "Hier trainierte Kompetenzen aus den SBC-Richtlinien (2017)",
  ...
  "titleLbl": "Titel",
  "modeDesc": {
   "normal": "XP ×1. Kostenlose Hinweise (ein Hinweis auf die richtige Antwort bringt die Hälfte). Jeder Fehler kostet 2 XP pro Ticket-Stufe.",
   "medio": "XP ×1,5. Jeder Hinweis kostet 5 XP. Jeder Fehler kostet 4 XP pro Ticket-Stufe.",
   "dificil": "XP ×2. Keine Hinweise und keine Optionen bei Ausgabe-Tickets: Du tippst ein, was das Programm ausgibt. Jeder Fehler kostet 6 XP pro Stufe.",
  ...
  "shopP": "Tausche deinen XP-Kontostand gegen Power-ups und Titel ein. Das Ausgeben des Kontostands verringert nicht die Lebenszeit-XP, die Stufen und Bosse freischaltet.",
  "powers": "Power-ups",
  "buy": "Einlösen für {c} XP",
  "evoH": "Wissenszuwachs",
  "plP": "Jede Sprache hat ihren eigenen Fortschritts-Tracker; die verwendete ist mit ● markiert. Wenn du eine Sprache zum ersten Mal ausprobierst, beginnst du mit einer Übertragungsschätzung: die Hälfte des Weges, den du in deiner besten Sprache bereits zurückgelegt hast. Fettgedruckte Werte wurden geübt.",
  "pilot": "Modell, das das Spiel antreibt",
  "rolePilot": "treibt an",
  "cmpNote": "Mit wenigen Antworten eines einzelnen Schülers schwanken diese Zahlen stark. Ein aussagekräftiger Vergleich verwendet die exportierten Protokolle vieler Schüler, aufgeteilt nach Schüler.",
  "colRole": "Rolle",
  "confirmRule": "Erfordert, dass der Wissensstand durch eine richtige Antwort an einem anderen Tag bestätigt wird.",
  "navReport": "Bericht",
  "homeLead": "Du bist gerade Ponte beigetreten, einer kleinen Softwarefirma, die die Bäckerei, das Gesundheitszentrum, die Schule und die Liefergenossenschaft in der Nachbarschaft betreut. Jeder Kunde bringt ein echtes Problem mit: Du hörst dir die Geschichte an, studierst den Theorie-Werkzeugkasten und nimmst erst dann die Tickets in Angriff.",
  "steps": [
   [
    "Hör dem Kunden zu",
   ...
   [
    "Bau deinen Theorie-Werkzeugkasten auf",
    "Schlüsselkonzepte, ein Codebeispiel in der Sprache deiner Wahl und die SBC-Lehrplankompetenz, die trainiert wird."
   ],
   [
    "Löse die Tickets",
    "Sag Ausgaben voraus, bring Code in die richtige Reihenfolge, jage Bugs und triff Engineering-Entscheidungen. Zu jeder Antwort gibt es eine praktische Analogie, und der Tutor verfolgt deinen Lernfortschritt."
   ]
  ],
  ...
  "snippetNote": "Java- und C-Schnipsel lassen die Klasse und die Hauptfunktion weg, um den Fokus auf das Konzept zu richten.",
  "startTickets": "Ich bin bereit: Gib die Tickets für diese Mission frei",
  "backBoard": "Zurück zum Brett",
  "types": {
   "mc": "Analysiere und antworte",
   "parsons": "Bring den Code in die richtige Reihenfolge",
   "bug": "Jage den Bug",
   "sort": "Ordne zu"
  },
  ...
  "roseNote": "Sie ist trotz des Fehlers leicht gestiegen, weil das Modell annimmt, dass das Lesen der Erklärung auch lehrt.",
  ...
  "repSub": "Eine Ansicht für den Lernenden und für die, die ihn unterstützen: was gemeistert ist, wo die Fehler liegen und was als Nächstes geübt werden sollte.",
  "k2": "Genauigkeit",
  "stL": "Gesperrt",
  "showJson": "JSON-Protokoll anzeigen",
  ...
  "useFifty": "Zwei entfernen verwenden ({n})",
  ...
  "evoP": "Jede Zeile ist die geschätzte Beherrschung einer Fähigkeit über die Tickets, die du beantwortet hast. Tippe auf eine Fähigkeit, um sie hervorzuheben: grüne Punkte sind richtige Antworten und bernsteinfarbene Punkte sind Fehler. Gestrichelte Linien markieren das Freischalten (60%) und die Beherrschung ({m}).",
  "models": {
   "elo": "Elo/Rasch",
   "irt": "3PL IRT mit EAP",
   "bkt": "BKT",
  ...
  "cmpH": "Modellvergleich zu diesem Verlauf",
  "confirmTag": "Bestätigung",
  "studentName": "Name des Schülers (optional, erscheint auf dem gedruckten Bericht)",
  "navBoard": "Board",
  "roles": [
   "Praktikant",
   "Junior",
  ...
  "howA": "Es ist die Schach-Elo-Zahl. Einen starken Gegner zu schlagen bringt viel, einen schwachen zu schlagen bringt wenig, und gegen einen schwachen zu verlieren kostet viel. Hier ist der Gegner das Ticket.",
  "base": "Basis-URL",
  "clear": "Schlüssel entfernen",
  "saved": "Einstellungen gespeichert.",
  "keyNote": "Der Schlüssel wird nur in diesem Browser (localStorage) gespeichert und direkt an den Anbieter gesendet. Verwende ihn nicht an einem gemeinsam genutzten Computer. Für den Unterricht ist ein lokaler Server besser (z. B. Ollama unter http://localhost:11434/v1), der keinen Schlüssel benötigt.",
  "navShop": "Shop",
  ...
  "shopA": "Das sind die Meilen eines Treueprogramms. Du gibst das Guthaben für Tickets aus; dein Kartenstatus hängt von den insgesamt geflogenen Meilen ab und sinkt nicht, wenn du einlöst.",
  ...
  "colTries": "Tickets",
  "plA": "Wer ein Auto mit Gangschaltung fahren kann, fängt bei einem Automatikauto nicht wieder bei null an, muss aber ein paar Runden um den Block drehen, um zu zeigen, dass er sich angepasst hat.",
  "plAcc": "Richtig",
  ...
  "bank": "Verfügbare Zeilen (zum Einsetzen antippen)",
  "sol": "Dein Programm (Zeile antippen, um sie zurückzulegen)",
  "retroH": "Sprint {n} Retrospektive",
  "retroB": "Gutes Tempo; sieh dir die zurückgebliebenen an.",
  ...
  "howParams": "Designparameter, noch nicht mit Daten kalibriert: Tickets der Stufen 1, 2 und 3 haben Schwierigkeiten von -1,2, 0 und +1,2 Logits; anfänglicher Zuwachs 1,8, der mit jeder Antwort schrumpft, wobei Fehler mit 70 % gewichtet werden, um Ausrutscher zu tolerieren; Raten nach Format (1 zu 4 bei Optionen, 1 pro Zeile bei Fehlern, 1 zu 16 beim Klassifizieren, 5 % beim Ordnen, 3 % bei getippten Antworten und 50 % mit einem Hinweis). Freischaltung bei 60 %, Beherrschung bei {m}, bestätigt an einem anderen Tag. 3PL IRT, BKT, PFA und AFM beobachten nur.",
  ...
  "bossLoseP": "Du hast {x} XP von deinem Guthaben verloren. Sieh dir die beteiligten Missionen an und komm für eine Revanche zurück.",
  "review": "Wiederholen",
  "shopH": "Shop",
  ...
  "cheers": [
   ...
   "Genau getroffen, scharfe Schlussfolgerung!",
  ...
  "pilotNote": "Ein Modell steuert das Spiel: Es berechnet die Beherrschung, schaltet Stufen frei und passt die Schwierigkeit an. Die anderen laufen im Hintergrund und zeichnen nur auf, was sie vor jeder Antwort vorhergesagt haben, für einen späteren Vergleich. Der Prozentsatz neben jedem Namen ist die Beherrschungsschwelle dieses Modells.",
  "roleShadow": "beobachtet",
  "cmpP": "Vor jeder Antwort zeichnen die fünf Modelle die Wahrscheinlichkeit einer richtigen Antwort auf, die sie vorhergesagt haben. Der Brier-Score misst den Vorhersagefehler (niedriger ist besser); der AUC misst, ob das Modell richtige Antworten von Fehlern trennt (0,5 bedeutet Zufall und 1 ist perfekt).",
  "confirmNote": "Heute wurde die Beherrschung erreicht. Um sie zu bestätigen, löse an einem anderen Tag ein Ticket dieser Fähigkeit richtig: Eine einzelne Sitzung vermischt Wissen mit Momentumschwung.",
  "stC": "An einem anderen Tag zu bestätigen",
  "repFor": "Schüler: {n}",
  "homeH": "Lerne Programmieren und Softwareentwicklung, indem du die Probleme echter Menschen löst",
  ...
  "aiExplain": "Bitte den KI-Tutor um eine andere Analogie",
  "retroC": "Harter Sprint. Tickets zur Überprüfung kommen später zurück aufs Board.",
  "stP": "In Bearbeitung",
  "noData": "keine Daten",
  ...
  "oops": [
   "Fast geschafft. Jeder Entwickler zerbricht den Build, bevor er ihn repariert.",
   "Fehler gehören zum Weg: Jetzt weißt du, wo die Falle war.",
   "Du hast einen Fehler in deiner Überlegung gefunden, und so lernt man Debugging.",
