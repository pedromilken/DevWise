...
LANG.de = {
 ...
 "ui": {
  ...
  "evoP": "Jede Zeile ist die geschätzte Beherrschung einer Fähigkeit über die beantworteten Tickets. Tippe auf eine Fähigkeit, um sie hervorzuheben: Grüne Punkte sind richtige Antworten und gelbe Punkte sind Fehler. Gestrichelte Linien markieren das Freischalten (60%) und die Beherrschung ({m}).",
  "models": {
   "elo": "Elo/Rasch",
   "irt": "3PL-IRT mit EAP",
   "bkt": "BKT",
  ...
  "cmpH": "Modellvergleich auf diesen Verlauf",
  "confirmTag": "Bestätigung",
  "studentName": "Name des Schülers (optional, wird auf dem gedruckten Bericht angezeigt)",
  "homeLangs": "Sprachen",
  "homePls": "Programmiersprachen",
  "runErr": "Der Code wurde nicht ausgeführt, daher ist die Punktzahl 0: {e}",
  "hidden": "Versteckte Fälle: {a} von {b} richtig. Sie existieren, damit die Lösung wirklich funktioniert und nicht nur für die sichtbaren Beispiele.",
  "codeEmpty": "Noch keine Codeübung beantwortet.",
  "teacherP": "Technische Einstellungen. Spieler müssen hier nichts ändern.",
  "runnerP": "JavaScript und Python laufen direkt im Browser. Java und C benötigen einen Server, der den Code kompiliert und ausführt; ohne einen solchen bleiben die Codeübungen in diesen Sprachen verborgen. Verwende deinen eigenen Piston-Server oder die öffentliche API von Piston, die seit Februar 2026 ein Token erfordert, das nicht-kommerziellen Bildungsprojekten gewährt wird.",
  "navReport": "Bericht",
  "homeLead": "Du bist gerade Ponte beigetreten, einer kleinen Softwarefirma, die die Nachbarschaftsbäckerei, das Gesundheitszentrum, die Schule und die Liefergenossenschaft betreut. Jeder Kunde bringt ein echtes Problem mit: Du hörst dir die Geschichte an, studierst den Theorie-Werkzeugkasten und nimmst erst dann die Tickets in Angriff.",
  "steps": [
   [
    "Hör dem Kunden zu",
   ...
   [
    "Baue deinen Theorie-Werkzeugkasten auf",
    "Schlüsselkonzepte, ein Codebeispiel in der Sprache deiner Wahl und die zu trainierende SBC-Lehrplankompetenz."
   ],
   [
    "Löse die Tickets",
    "Sag Ausgaben voraus, ordne Code, jage Bugs und triff Engineering-Entscheidungen. Jede Antwort kommt mit einer praktischen Analogie, und der Tutor verfolgt deinen Lernfortschritt."
   ]
  ],
  "toReview": "zu überprüfen",
  "areaProg": "Programmierung",
  "mapHint": "Tippe auf eine Fertigkeit, um Details zu sehen. Die Zahl ist die geschätzte Wahrscheinlichkeit, dass du sie bereits beherrschst.",
  "and": " und ",
  ...
  "backBoard": "Zurück zum Brett",
  "types": {
   "mc": "Analysiere und antworte",
   "parsons": "Ordne den Code",
   "bug": "Jage den Bug",
   "sort": "Klassifiziere"
  },
  "diff": "Schwierigkeit {d} von 3",
  "hintNote": "Mit einem Hinweis bringt eine richtige Antwort die Hälfte der XP und zählt als schwächerer Beweis für die Beherrschung.",
  "up": "Nach oben",
  "notYet": "Diesmal nicht",
  "roseNote": "Es stieg trotz des Fehlers leicht an, weil das Modell annimmt, dass das Lesen der Erklärung auch lehrt.",
  "toRetro": "Sieh dir die Sprint-Retrospektive an",
  "retroSum": "{c} von {n} Tickets gelöst. ",
  "colSkill": "Fertigkeit",
  "allDone": "Jede Fertigkeit ist gemeistert. Die nächsten Sprints sind freies Üben.",
  "nextSprint": "Starte Sprint {n}",
  "repSub": "Eine Ansicht für den Schüler und für alle, die ihn unterstützen: was gemeistert ist, wo die Fehler liegen und was als Nächstes geübt werden sollte.",
  "k2": "Genauigkeit",
  "stL": "Gesperrt",
  "showJson": "Zeige das JSON-Protokoll",
  "reset": "Fortschritt löschen",
  "model": "Modell",
  "modeH": "Schwierigkeit",
  "yourAnswer": "Deine Antwort: {a}",
  "timeout": "Die Zeit ist um.",
  "hintPaid": "Frag nach einem Hinweis (kostet {c} XP)",
  "noHints": "In diesem Modus gibt es keine Hinweise.",
  "useFifty": "Nutze Zwei entfernen ({n})",
  "bountyDone": "Herausforderung abgeschlossen: {s} (+{x} XP)",
  "bossesH": "Bosse",
  "bossLocked": "Benötigt 60% in {p} und {x} Lebenszeit-XP.",
  "bossDefeated": "Besiegt",
  "bossFight": "Stell dich dem Boss",
  "titlesH": "Titel",
  "owned": "Du hast: {n}",
  ...
  "nothingDone": "Noch nichts. Nimm ein Ticket, um den Sprint zu starten.",
  "areaSE": "Softwareentwicklung",
  ...
  "stB": "Mission zum Öffnen",
  "recs": "Empfehlungen des Tutors",
  "recBloom": "Kognitive Ebene mit den meisten Fehlern: {b} ({c} von {n}). Übe diese Art von Ticket in Ruhe, ohne Hinweise.",
  "howA": "Es ist wie die Schach-Elo-Zahl. Einen starken Gegner zu schlagen bringt viel, einen schwachen zu schlagen bringt wenig, und gegen einen schwachen zu verlieren kostet viel. Hier ist der Gegner das Ticket.",
  "base": "Basis-URL",
  "clear": "Schlüssel entfernen",
  "saved": "Einstellungen gespeichert.",
  "keyNote": "Der Schlüssel wird nur in diesem Browser gespeichert (localStorage) und direkt an den Anbieter gesendet. Verwende ihn nicht auf einem gemeinsam genutzten Computer. Für den Unterricht bevorzuge einen lokalen Server (zum Beispiel Ollama unter http://localhost:11434/v1), der keinen Schlüssel benötigt.",
  "navShop": "Shop",
  "bountiesH": "Sprint-Herausforderungen",
  "dailyH": "Tägliche Herausforderung",
  "dailyDone": "Tägliche Herausforderung erledigt. Morgen kommt eine neue.",
  "bossStage": "Stufe {n} von {m}",
  "bossWin": "Boss besiegt",
  "reward": "Belohnung: {x} XP",
  "shopA": "Das sind die Meilen eines Vielfliegerprogramms. Du gibst das Guthaben für Tickets aus; dein Kartenstatus hängt von den insgesamt geflogenen Meilen ab und sinkt nicht, wenn du einlöst.",
  ...
  "colTries": "Tickets",
  "plA": "Wer Schaltwagen fahren kann, fängt bei Automatik nicht bei null an, braucht aber ein paar Runden um den Block, um zu zeigen, dass er sich angepasst hat.",
  "plAcc": "Richtig",
  "printBtn": "Drucken oder als PDF speichern",
  "homeSbc": "Die 14 Missionen decken Programmierung und Softwareentwicklung ab, und jede einzelne nennt die Kompetenzen aus den SBC Curriculum Guidelines (2017), die sie trainiert. Dasselbe Konzept erscheint in vier Programmiersprachen, mit demselben Lösungsschlüssel.",
  "codeFn": "Schreibe die Funktion {f}. Der Name muss genau so lauten.",
  "runBtn": "Ausführen",
  "codeH": "Freie-Code-Übungen",
  "codeAuth": "Was das beweist und was nicht: Der Fingerabdruck und der Zeitstempel beweisen, dass dieser Code zu diesem Zeitpunkt eingereicht wurde; die Anzahl der Einfügungen und die Zeit beschreiben den Prozess. Nichts davon beweist die Urheberschaft, denn alles wird im eigenen Browser des Lernenden aufgezeichnet. Für benotete Prüfungen ergänze betreute Arbeit oder eine Verteidigung des Codes selbst.",
  "codeHidden": "Freie-Code-Übungen in {l} bleiben verborgen, bis ein Lehrer einen Ausführungsdienst einrichtet. In Python und JavaScript erscheinen sie wie gewohnt.",
  "runnerToken": "Autorisierungstoken (falls der Dienst einen benötigt)",
  "runnerOn": "Java und C: Ausführung aktiviert.",
  "colTime": "Zeit",
  ...
  "map": "Meisterkarte",
  "sbcH": "Hier trainierte Kompetenzen aus den SBC-Curriculumrichtlinien (2017)",
  "check": "Antwort prüfen",
  "aiFail": "Der KI-Tutor hat nicht geantwortet. Prüfe die Einstellungen oder nutze den regulären Hinweis.",
  "allUsed": "Alle Zeilen wurden verwendet.",
  "options": "Optionen",
  "codeLines": "Codezeilen",
  "delta": "Meisterschaft von {s}: {a} auf {b}   (+{x} XP)",
  "changed": "Was sich an deiner Meisterschaft geändert hat",
  "k1": "beantwortete Tickets",
  "colHits": "Richtig",
  "recNone": "Noch keine Antworten. Löse ein paar Tickets, damit der Tutor Belege hat.",
  "howP": "Der Tutor verwendet ein Elo/Rasch-Modell. Jede deiner Fähigkeiten hat eine Bewertung, und jedes Ticket hat eine Schwierigkeit auf derselben Skala. Der Abstand zwischen beiden ergibt die Wahrscheinlichkeit einer richtigen Antwort. Nach deiner Antwort wird die Bewertung proportional zur Überraschung nach oben oder unten angepasst. Die angezeigte Meisterschaft ist deine Wahrscheinlichkeit, ein Ticket mittlerer Schwierigkeit ohne Raten zu lösen, und eine Fähigkeit gilt ab {m} als gemeistert.",
  "aiP": "Der KI-Tutor verfasst maßgeschneiderte sokratische Hinweise und neue Analogien in der Spielsprache, ohne die Lösung zu verraten. Ohne ihn verwendet das Spiel die von den Autoren geschriebenen Hinweise.",
  "aiClaude": "Über diesen Link mit Claude verbunden. In der auf GitHub veröffentlichten Version benötigt der Tutor einen API-Schlüssel.",
  "none": "Nichts",
  "titleLbl": "Titel",
  "modeDesc": {
   "normal": "XP ×1. Kostenlose Hinweise (eine mit Hinweis richtig beantwortete Frage bringt die halbe XP). Jeder Fehler kostet 2 XP pro Ticketstufe.",
   "medio": "XP ×1,5. Jeder Hinweis kostet 5 XP. Jeder Fehler kostet 4 XP pro Ticketstufe.",
  ...
  "lost": "Strafe: -{x} XP von deinem Kontostand.",
  "useTime": "+30 s verwenden ({n})",
  "bossLives": "Noch erlaubte Fehler: {n}",
  "shopP": "Tausche deinen XP-Kontostand gegen Power-ups und Titel. Die Ausgabe des Kontostands verringert nicht die Lebenszeit-XP, die Stufen und Bosse freischaltet.",
  "powers": "Power-ups",
  "buy": "Einlösen für {c} XP",
  "evoH": "Wissenszuwachs",
  "plP": "Jede Sprache hat ihren eigenen Meisterschafts-Tracker; die aktuell verwendete ist mit ● markiert. Wenn du eine Sprache zum ersten Mal ausprobierst, beginnst du mit einer Übertragungsschätzung: die Hälfte des Weges, der in deiner besten Sprache bereits zurückgelegt wurde. Fettgedruckte Werte wurden geübt.",
  ...
  "colRole": "Rolle",
  "confirmRule": "Meisterschaft muss durch eine richtige Antwort an einem anderen Tag bestätigt werden",
  "homeMissions": "Missionen mit Geschichte und Theorie",
  "homeTickets": "Tickets in der Bank",
  "submit": "Zur Bewertung einreichen",
  "noExecP": "Diese Übung kann nur mit einem Code-Ausführungsdienst bewertet werden, den ein Lehrer unter Einstellungen, unter Für Lehrer und Forschung, einrichtet. Wähle in der Zwischenzeit in den Einstellungen Python oder JavaScript, um die Code-Übungen zu lösen.",
  "checkN": {
  ...
  "infra": {
   ...
   "auth": "Der Ausführungsdienst hat den Zugriff verweigert. Prüfe das Token in den Einstellungen.",
   "rede": "Der Ausführungsdienst hat nicht geantwortet. Prüfe die Verbindung und versuche es erneut.",
   "pyodide": "Python konnte nicht heruntergeladen werden. Beim ersten Mal wird eine Internetverbindung benötigt; prüfe die Verbindung und versuche es erneut.",
  ...
  "homeH": "Lerne Programmieren und Softwareentwicklung, indem du Probleme echter Menschen löst",
  "todoEmpty": "Öffne eine Mission oben, um ihre Tickets zu erhalten.",
  "lockedAria": "gesperrt",
  "aiHint": "Frag den KI-Tutor um einen Hinweis",
  "tutorHint": "Hinweis des Tutors: ",
  "solved": "Ticket gelöst",
  "promo": "Beförderung: Deine Rolle ist jetzt {r}.",
  "aiExplain": "Frag den KI-Tutor nach einer anderen Analogie",
  ...
  "aiOff": "Aus: Das Spiel verwendet die von den Autoren geschriebenen Hinweise. Um es einzuschalten, trage unten einen Anbieter ein.",
  "provider": "Anbieter",
  ...
  "oops": [
   ...
   "Diesmal nicht, und das ist in Ordnung. Nimm dir Zeit mit der Erklärung."
  ],
  "comeback": "Komm zurück: +{x} XP, wenn du direkt nach einem Fehler richtig liegst.",
  ...
  "homeI18n": "Das Spiel gibt es in 20 Sprachen, dieselben wie bei der Übersetzungs- und Tokenisierungsanalyse, die das Projekt leitet. Rechts-nach-links-Schriften werden unterstützt, und Sprachen mit eigener Schrift bieten eine romanisierte Version.",
  "aiDebug": "Frag den Tutor um Hilfe",
  "telLive": "Dein bisheriger Prozess: {p} Einfügungen, {r} Ausführungen, {s} s.",
  "colPaste": "Einfügungen",
  "codeP": "Jede Einreichung speichert die Punktzahl, den Prozess, der dazu geführt hat, und einen Fingerabdruck des gesendeten Codes.",
  "xp": "XP",
  "navSettings": "Einstellungen",
  "cont": "Weitermachen, wo ich aufgehört habe",
  "openBrief": "Geschichte anhören und Theorie studieren",
  "resolved": "gelöst",
  ...
  "sol": "Dein Programm (Zeile antippen, um sie zurückzulegen)",
  "retroH": "Retrospektive von Sprint {n}",
  "retroB": "Gutes Tempo; sieh dir die zurückgelassenen an.",
  "colStart": "Sprintstart",
  ...
  "colSbc": "SBC",
  "recPriority": "Priorität: {s} ({p} Beherrschung, {c} richtig von {n}).",
  ...
  "howParams": "Designparameter, noch nicht an Daten kalibriert: Tickets der Stufen 1, 2 und 3 haben Schwierigkeiten von -1,2, 0 und +1,2 Logits; anfänglicher Zuwachs 1,8, der mit jeder Antwort schrumpft, Fehler werden mit 70% gewichtet, um Ausrutscher zu tolerieren; Raten nach Format (1 von 4 bei Optionen, 1 pro Zeile bei Fehlern, 1 von 16 beim Klassifizieren, 5% beim Anordnen, 3% bei getippten Antworten und 50% mit Hinweis). Freischaltung bei 60%, Beherrschung bei {m}, bestätigt an einem anderen Tag. 3PL IRT, BKT, PFA und AFM beobachten nur.",
  ...
  "bossLoseP": "Du hast {x} XP von deinem Kontostand verloren. Sieh dir die beteiligten Missionen an und komm für eine Revanche zurück.",
  "review": "Wiederholen",
  "shopH": "Shop",
  ...
  "cheers": [
   ...
   "Volltreffer, scharfe Schlussfolgerung!",
   "Ticket mit Stil geschlossen!"
  ],
  "need": "{n} XP übrig (kostet {c})",
  "evoX": "Tickets beantwortet",
  "colFirst": "Erste Schätzung",
  "plH": "Beherrschung nach Programmiersprache",
  "rom": "Romanisierten Text anzeigen (lateinisches Alphabet)",
  "pilotNote": "Ein Modell steuert das Spiel: Es berechnet die Beherrschung, schaltet Stufen frei und passt den Schwierigkeitsgrad an. Die anderen laufen im Hintergrund und zeichnen nur auf, was sie vor jeder Antwort vorhergesagt haben, zum späteren Vergleich. Der Prozentsatz neben jedem Namen ist die Beherrschungsschwelle dieses Modells.",
  ...
  "confirmNote": "Beherrschung heute erreicht. Um sie zu bestätigen, löse an einem anderen Tag ein Ticket dieser Fähigkeit richtig: Eine einzelne Sitzung vermischt Wissen mit Schwung.",
  "stC": "An einem anderen Tag zu bestätigen",
  "repFor": "Schüler: {n}",
  "navHome": "Start",
  "homeSciH": "Wie das Tool gebaut wurde",
  "bands": [
   "Unregelmäßig",
   "Ausreichend",
   "Gut",
  ...
  "pilotFixed": "{m} steuert das Spiel: Es berechnet die Beherrschung, schaltet Stufen frei und wählt den Schwierigkeitsgrad, mit Beherrschung von {p}. BKT, PFA, AFM und 3PL IRT laufen bei jeder Antwort im Hintergrund und zeichnen nur auf, was sie vorhergesagt haben, zum Vergleich im Tab Bericht und in den exportierten Daten."
 },
 "sbc": {
 ...
 "items": {
  ...
  "w1": {
   "title": "Die Versandgebühr der Genossenschaft",
   "prompt": "Schreibe die Versandfunktion: 5 Real fest plus 2 Real pro Kilometer.",
   "hint": "Eine Zeile genügt: Gib das Ergebnis der Berechnung zurück, nicht ausgeben.",
   "why": "Die Regel wird zu einer benannten Funktion, die von der Website, der App und der Tabelle aufgerufen werden kann, ohne dass voneinander abweichende Kopien entstehen.",
  ...
  "w2": {
   ...
   "hint": "Beginne mit einem Akkumulator bei null und gehe die Liste durch und addiere.",
   "why": "Das ist das Akkumulator-Muster: ein neutraler Startwert, eine Addition pro Runde, das Ergebnis wird nach der Schleife zurückgegeben.",
  ...
  "w3": {
   ...
   "hint": "Die schwerwiegendste Regel kommt zuerst, und jeder Patient verlässt mit einer einzigen Stufe.",
   "why": "Die Kette von Bedingungen garantiert ein Ergebnis pro Patient. Die Grenzwerte, 39 und 37,5, sind genau dort, wo sich Fehler zeigen.",
   "analogy": "Das ist das Protokoll an der Klinikwand: von oben nach unten gelesen, bei der ersten passenden Zeile angehalten."
  },
  "w4": {
   "title": "Wie viele überschreiten das Limit",
   ...
   "why": "Zählen unterscheidet sich vom Addieren: Der Zähler bewegt sich um eins, egal wie groß der Wert ist. Größer als das Limit schließt den Wert gleich dem Limit aus.",
  ...
  "w5": {
   ...
   "why": "Ohne Basisfall ruft sich die Funktion ewig selbst auf. Mit ihm bewegt sich jeder Aufruf gegen null und die Antworten kommen multiplizierend zurück.",
   "analogy": "Das sind die russischen Puppen: Du hörst bei der massiven auf und kommst zurück, indem du sie eine nach der anderen schließt."
  },
  "w6": {
   "title": "Das Wechselgeld der Bäckerei",
   "prompt": "Schreibe die Funktion, die das Wechselgeld zurückgibt: wie viel vom bezahlten Betrag übrig bleibt, nachdem der Preis abgezogen wurde.",
   "hint": "Eine Subtraktion und eine Rückgabe. Preis und bezahlt kommen als Parameter an.",
   ...
   "analogy": "Das ist der Taschenrechner auf der Theke: Er nimmt die zwei Zahlen, zeigt die Differenz und behält nichts für sich."
  }
 },
 "game": {
  "shop": {
