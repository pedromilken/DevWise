...
/* ---------- Desafios extras de código: bônus no quadro e Oficina ----------
   kind "rule": com restrição (rules: forbid/require por linguagem; violar limita a nota a Regular, 59%).
   kind "free": livre, só os casos de teste valem. Não entram no sorteio normal do quadro. */
{id:"x1",skill:"loop",type:"code",extra:true,kind:"rule",d:1,bloom:3,sig:{args:["int","int"],ret:"int"},fn:"mult",
 tests:[{args:[3,4],out:12},{args:[5,0],out:0},{args:[0,7],out:0},{args:[12,12],out:144,oculto:true},{args:[1,9],out:9,oculto:true}],
 rules:[{id:"noMul",forbid:{all:"\\*"}},{id:"useFor",require:{all:"\\bfor\\b"}}],
 stub:four(`def mult(a, b):\n    `,
`function mult(a, b) {\n  \n}`,
`static int mult(int a, int b) {\n  \n}`,
`int mult(int a, int b) {\n  \n}`)},
{id:"x2",skill:"loop",type:"code",extra:true,kind:"rule",d:2,bloom:3,sig:{args:["int","int"],ret:"int"},fn:"power",
 tests:[{args:[2,10],out:1024},{args:[5,0],out:1},{args:[3,3],out:27},{args:[7,2],out:49,oculto:true},{args:[1,50],out:1,oculto:true}],
 rules:[{id:"noPow",forbid:{py:"\\*\\*|\\bpow\\s*\\(",js:"\\*\\*|Math\\.pow",java:"Math\\.pow",c:"\\bpow\\s*\\("}},{id:"useLoop",require:{all:"\\bfor\\b|\\bwhile\\b"}}],
 stub:four(`def power(base, exp):\n    `,
`function power(base, exp) {\n  \n}`,
`static int power(int base, int exp) {\n  \n}`,
`int power(int base, int exp) {\n  \n}`)},
{id:"x3",skill:"col",type:"code",extra:true,kind:"rule",d:2,bloom:3,sig:{args:["int[]"],ret:"int"},fn:"largest",
 tests:[{args:[[3,9,2]],out:9},{args:[[-5,-1,-9]],out:-1},{args:[[7]],out:7},{args:[[4,4,4]],out:4,oculto:true},{args:[[1,50,3,49]],out:50,oculto:true}],
 rules:[{id:"noMax",forbid:{py:"\\bmax\\s*\\(|\\bsorted\\s*\\(|\\.sort\\s*\\(",js:"Math\\.max|\\.sort\\s*\\(|\\.reduce\\s*\\(",java:"Math\\.max|Collections|Arrays\\.sort|stream",c:"qsort|fmax"}},{id:"useLoop",require:{all:"\\bfor\\b|\\bwhile\\b"}}],
 stub:four(`def largest(values):\n    `,
`function largest(values) {\n  \n}`,
`static int largest(int[] values) {\n  \n}`,
`int largest(int values[], int n) {\n  \n}`)},
{id:"x4",skill:"col",type:"code",extra:true,kind:"rule",d:2,bloom:3,sig:{args:["int[]"],ret:"double"},fn:"average",
 tests:[{args:[[2,4,6]],out:4},{args:[[5]],out:5},{args:[[1,2]],out:1.5},{args:[[10,0,5,5]],out:5,oculto:true},{args:[[3,4]],out:3.5,oculto:true}],
 rules:[{id:"noSum",forbid:{py:"\\bsum\\s*\\(|\\bmean\\b|statistics",js:"\\.reduce\\s*\\(",java:"stream|IntStream|\\.sum\\s*\\(|\\.average\\s*\\("}},{id:"useLoop",require:{all:"\\bfor\\b|\\bwhile\\b"}}],
 stub:four(`def average(values):\n    `,
`function average(values) {\n  \n}`,
`static double average(int[] values) {\n  \n}`,
`double average(int values[], int n) {\n  \n}`)},
{id:"x5",skill:"cond",type:"code",extra:true,kind:"rule",d:2,bloom:4,sig:{args:["int"],ret:"String"},fn:"parity",
 tests:[{args:[4],out:"even"},{args:[7],out:"odd"},{args:[0],out:"even"},{args:[100],out:"even",oculto:true},{args:[99],out:"odd",oculto:true}],
 rules:[{id:"noMod",forbid:{py:"%|\\bdivmod\\b",js:"%",java:"%",c:"%"}},{id:"useCond",require:{all:"\\bif\\b|\\?"}}],
 stub:four(`def parity(n):\n    `,
`function parity(n) {\n  \n}`,
`static String parity(int n) {\n  \n}`,
`const char *parity(int n) {\n  \n}`)},
{id:"x6",skill:"col",type:"code",extra:true,kind:"rule",d:3,bloom:3,sig:{args:["String"],ret:"String"},fn:"reverse",
 tests:[{args:["abc"],out:"cba"},{args:[""],out:""},{args:["a"],out:"a"},{args:["DevWise"],out:"esiWveD",oculto:true},{args:["ana"],out:"ana",oculto:true}],
 rules:[{id:"noRev",forbid:{py:"\\[\\s*:\\s*:\\s*-\\s*1\\s*\\]|\\breversed\\s*\\(|\\.reverse\\s*\\(",js:"\\.reverse\\s*\\(",java:"StringBuilder|StringBuffer|\\.reverse\\s*\\(|Collections",c:"strrev"}},{id:"useLoop",require:{all:"\\bfor\\b|\\bwhile\\b"}}],
 stub:four(`def reverse(text):\n    `,
`function reverse(text) {\n  \n}`,
`static String reverse(String text) {\n  \n}`,
`char *reverse(const char *text) {\n  \n}`)},
{id:"x7",skill:"func",type:"code",extra:true,kind:"rule",d:2,bloom:3,sig:{args:["double","String","double"],ret:"double"},fn:"calc",
 tests:[{args:[2,"+",3],out:5},{args:[10,"-",4],out:6},{args:[6,"*",7],out:42},{args:[10,"/",4],out:2.5},{args:[9,"/",3],out:3,oculto:true},{args:[0,"*",5],out:0,oculto:true}],
 rules:[{id:"noEval",forbid:{py:"\\beval\\s*\\(|\\bexec\\s*\\(",js:"\\beval\\s*\\(|Function\\s*\\(",java:"ScriptEngine"}},{id:"useCond",require:{all:"\\bif\\b|\\bswitch\\b|\\bmatch\\b|\\?"}}],
 stub:four(`def calc(a, op, b):\n    `,
`function calc(a, op, b) {\n  \n}`,
`static double calc(double a, String op, double b) {\n  \n}`,
`double calc(double a, const char *op, double b) {\n  \n}`)},
{id:"x8",skill:"func",type:"code",extra:true,kind:"free",d:2,bloom:3,sig:{args:["double","double"],ret:"String"},fn:"bmi_class",
 tests:[{args:[50,1.8],out:"under"},{args:[70,1.75],out:"normal"},{args:[85,1.75],out:"over"},{args:[100,1.7],out:"obese"},{args:[18.5,1],out:"normal",oculto:true},{args:[25,1],out:"over",oculto:true},{args:[30,1],out:"obese",oculto:true}],
 rules:[],
 stub:four(`def bmi_class(weight, height):\n    `,
`function bmi_class(weight, height) {\n  \n}`,
`static String bmi_class(double weight, double height) {\n  \n}`,
`const char *bmi_class(double weight, double height) {\n  \n}`)},
{id:"x9",skill:"loop",type:"code",extra:true,kind:"free",d:2,bloom:3,sig:{args:["String"],ret:"int"},fn:"count_vowels",
 tests:[{args:["banana"],out:3},{args:["xyz"],out:0},{args:["Programming"],out:3},{args:["AEIOU aeiou"],out:10,oculto:true},{args:[""],out:0,oculto:true}],
 rules:[],
 stub:four(`def count_vowels(text):\n    `,
`function count_vowels(text) {\n  \n}`,
`static int count_vowels(String text) {\n  \n}`,
`int count_vowels(const char *text) {\n  \n}`)},
{id:"x10",skill:"cond",type:"code",extra:true,kind:"free",d:1,bloom:3,sig:{args:["int"],ret:"String"},fn:"fizzbuzz",
 tests:[{args:[3],out:"Fizz"},{args:[5],out:"Buzz"},{args:[15],out:"FizzBuzz"},{args:[7],out:"7"},{args:[30],out:"FizzBuzz",oculto:true},{args:[1],out:"1",oculto:true}],
 rules:[],
 stub:four(`def fizzbuzz(n):\n    `,
`function fizzbuzz(n) {\n  \n}`,
`static String fizzbuzz(int n) {\n  \n}`,
`const char *fizzbuzz(int n) {\n  \n}`)},
{id:"x11",skill:"rec",type:"code",extra:true,kind:"rule",d:3,bloom:4,sig:{args:["int"],ret:"int"},fn:"digit_sum",
 tests:[{args:[123],out:6},{args:[0],out:0},{args:[9],out:9},{args:[98765],out:35,oculto:true},{args:[1000],out:1,oculto:true}],
 rules:[{id:"noLoop",forbid:{all:"\\bfor\\b|\\bwhile\\b"}},{id:"selfCall",require:{all:"\\bdigit_sum\\s*\\(",min:2}}],
 stub:four(`def digit_sum(n):\n    `,
`function digit_sum(n) {\n  \n}`,
`static int digit_sum(int n) {\n  \n}`,
`int digit_sum(int n) {\n  \n}`)},
{id:"x12",skill:"var",type:"code",extra:true,kind:"free",d:2,bloom:3,sig:{args:["int"],ret:"String"},fn:"hms",
 tests:[{args:[3661],out:"01:01:01"},{args:[0],out:"00:00:00"},{args:[59],out:"00:00:59"},{args:[86399],out:"23:59:59",oculto:true},{args:[600],out:"00:10:00",oculto:true}],
 rules:[],
 stub:four(`def hms(seconds):\n    `,
