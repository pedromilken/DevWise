...
LANG.id = {
 ...
 "ui": {
  ...
  "changed": "Perubahan penguasaanmu",
  "k1": "tiket dijawab",
  "colHits": "Benar",
  "recNone": "Belum ada jawaban. Selesaikan beberapa tiket agar tutor punya data.",
  "howP": "Tutor menggunakan model Elo/Rasch. Setiap keterampilanmu punya rating, dan setiap tiket punya tingkat kesulitan pada skala yang sama. Selisih keduanya menentukan peluang jawaban benar; setelah kamu menjawab, rating naik atau turun sebanding dengan kejutan. Penguasaan yang ditampilkan adalah peluangmu menyelesaikan tiket dengan kesulitan rata-rata tanpa menebak, dan keterampilan dianggap dikuasai mulai dari {m}.",
  "aiP": "Tutor AI menulis petunjuk Socrates yang disesuaikan dan analogi segar dalam bahasa game, tanpa memberikan jawaban langsung. Tanpa AI, game menggunakan petunjuk yang ditulis oleh penulis.",
  "aiClaude": "Terhubung melalui Claude: tidak perlu kunci di halaman ini.",
  "none": "Tidak ada",
  "titleLbl": "Judul",
  "modeDesc": {
   "normal": "XP ×1. Petunjuk gratis (jawaban benar dengan petunjuk mendapat setengah). Setiap kesalahan memotong 2 XP per level tiket.",
   "medio": "XP ×1.5. Setiap petunjuk memotong 5 XP. Setiap kesalahan memotong 4 XP per level tiket.",
   "dificil": "XP ×2. Tanpa petunjuk dan tanpa pilihan pada tiket output: kamu mengetik apa yang dicetak program. Setiap kesalahan memotong 6 XP per level.",
   "hardcore": "XP ×3. Tanpa petunjuk, jawaban diketik, dan waktu 60 detik. Setiap kesalahan memotong 10 XP per level."
  },
  "lost": "Penalti: -{x} XP dari saldomu.",
  "useTime": "Gunakan +30 detik ({n})",
  "bossLives": "Kesalahan yang masih diizinkan: {n}",
  "shopP": "Tukarkan saldo XP-mu dengan power-up dan gelar. Membelanjakan saldo tidak mengurangi XP seumur hidup, yang menjadi syarat membuka tahap dan bos.",
  "powers": "Power-up",
  "buy": "Tukar dengan {c} XP",
  "evoH": "Pertumbuhan pengetahuan",
  "plP": "Setiap bahasa punya pelacak penguasaan sendiri; yang sedang digunakan ditandai dengan ●. Saat pertama mencoba bahasa, kamu mulai dari perkiraan transfer: setengah dari pencapaian di bahasa terbaikmu. Nilai yang dicetak tebal sudah dilatih.",
  "pilot": "Model yang menggerakkan game",
  "rolePilot": "menggerakkan",
  "cmpNote": "Dengan sedikit jawaban dari satu siswa, angka-angka ini berfluktuasi besar. Perbandingan yang valid menggunakan log yang diekspor dari banyak siswa, dipisah per siswa.",
  "colRole": "Peran",
  ...
  "role": "Peran",
  "streak": "Streak",
  "freePlay": "Kamu sudah menguasai semuanya. Papan sekarang jadi latihan bebas.",
  ...
  "shieldUsed": "Perisai kamu menyerap penalti.",
  ...
  "studentName": "Nama siswa (opsional, ditampilkan di laporan tercetak)",
  "navBoard": "Papan",
  "roles": [
   "Magang",
   "Junior",
  ...
  "missions": "Misi baru",
  "nothingDone": "Belum ada. Pilih tiket untuk membuka sprint.",
  "areaSE": "Rekayasa perangkat lunak",
  "masteredTxt": "Dikuasai. ",
  "reread": "Baca kembali cerita dan teorinya",
  "client": "Klien",
  "bloom": [
   "Ingat",
   "Pahami",
  ...
  "k4": "rekor beruntun benar terpanjang",
  ...
  "howA": "ini seperti rating catur. Mengalahkan lawan kuat bernilai banyak, mengalahkan lawan lemah bernilai sedikit, dan kalah dari lawan lemah itu merugikan. Di sini lawannya adalah tiket.",
  "base": "URL dasar",
  "clear": "Hapus kunci",
  "saved": "Pengaturan tersimpan.",
  "keyNote": "Kunci hanya disimpan di peramban ini (localStorage) dan dikirim langsung ke penyedia. Jangan gunakan di komputer bersama. Untuk penggunaan kelas, lebih baik memakai server lokal (misalnya, Ollama di http://localhost:11434/v1), yang tidak memerlukan kunci.",
  "navShop": "Toko",
  "bountiesH": "Tantangan sprint",
  "dailyH": "Tantangan harian",
  "dailyDone": "Tantangan harian selesai. Tantangan baru akan datang besok.",
  "bossStage": "Tahap {n} dari {m}",
  "bossWin": "Bos dikalahkan",
  "reward": "Hadiah: {x} XP",
  "shopA": "ini seperti miles dalam program loyalitas. Kamu membelanjakan saldo untuk tiket; tingkat kartumu bergantung pada total miles yang diterbangkan dan tidak turun saat kamu menukarkannya.",
  "equipped": "Sedang dipakai",
  "keepGoing": "Tiket ini akan kembali ke papan nanti untuk pertandingan ulang.",
  "streakMsg": "{n} kali beruntun! Bonus beruntun: +5 XP.",
  "colTries": "Tiket",
  "plA": "seseorang yang bisa mengendarai mobil manual tidak mulai dari nol saat mengendarai mobil matic, tetapi tetap perlu beberapa putaran di sekitar blok untuk membuktikan diri sudah beradaptasi.",
  "plAcc": "Benar",
  "printBtn": "Cetak atau simpan sebagai PDF",
  "xp": "XP",
  "navSettings": "Pengaturan",
  "cont": "Lanjutkan dari titik terakhir",
  "openBrief": "Dengarkan cerita dan pelajari teorinya",
  "resolved": "terselesaikan",
  "estTxt": "Estimasi penguasaan {p}.",
  "arsenal": "Kotak alat teori",
  "example": "Contoh kode",
  "aiLabel": "Tutor AI: ",
  ...
  "recHints": "Petunjuk digunakan di {p} tiket. Cobalah membentuk hipotesis sebelum bertanya.",
  "how": "Bagaimana penguasaan dihitung",
  "howParams": "Parameter desain, belum dikalibrasi pada data: tiket level 1, 2, dan 3 memiliki kesulitan -1.2, 0, dan +1.2 logit; gain awal 1.8, menyusut seiring setiap jawaban, dengan kesalahan diberi bobot 70% untuk menoleransi selip; tebakan berdasarkan format (1 dari 4 untuk opsi, 1 per baris untuk bug, 1 dari 16 saat klasifikasi, 5% saat pengurutan, 3% untuk jawaban diketik, dan 50% dengan petunjuk). Terbuka di 60%, penguasaan di {m}, dikonfirmasi pada hari lain. 3PL IRT, BKT, PFA, dan AFM hanya mengamati.",
  "dataP": "Progres hanya tersimpan di browser ini. Log mengikuti format panjang dari dataset knowledge tracing (item, keterampilan, kebenaran, bahasa, bahasa pemrograman, stempel waktu).",
  "hideJson": "Sembunyikan log JSON",
  "download": "Unduh JSON",
  "aiH": "Tutor AI",
  "aiKeyOn": "Dikonfigurasi dengan kunci milikmu sendiri ({m}).",
  "typedLbl": "Ketik persis apa yang dicetak program",
  "expected": "Keluaran yang benar: {a}",
  "timeLeft": "Waktu: {s} dtk",
  "lockedXp": "Terkunci: membutuhkan 60% di {p} dan {x} XP seumur hidup (kamu punya {y}).",
  ...
  "evoX": "tiket terjawab",
  "colFirst": "Estimasi pertama",
  "plH": "Penguasaan per bahasa pemrograman",
  "rom": "Tampilkan teks romawi (alfabet Latin)",
  "pilotNote": "Satu model menggerakkan permainan: model ini menghitung penguasaan, membuka tahap, dan menyesuaikan kesulitan. Model lain berjalan di latar belakang dan hanya mencatat prediksi mereka sebelum setiap jawaban, untuk perbandingan nanti. Persentase di samping setiap nama adalah ambang penguasaan model itu.",
  "roleShadow": "mengamati",
  "cmpP": "Sebelum setiap jawaban, lima model mencatat probabilitas respons benar yang mereka prediksi. Brier mengukur kesalahan prediksi (lebih rendah lebih baik); AUC mengukur apakah model memisahkan jawaban benar dari kesalahan (0.5 adalah kebetulan dan 1 sempurna).",
  ...
  "todoEmpty": "Buka misi di atas untuk menerima tiketmu.",
  "lockedAria": "terkunci",
  ...
  "retroC": "Sprint yang berat. Tiket untuk ditinjau akan kembali ke papan nanti.",
  "stP": "Sedang berjalan",
  ...
  "err": "Kesalahan",
  "dailyTag": "XP Ganda",
  "bossWinP": "Kamu memperoleh {x} XP dan trofi \"{t}\".",
  "bossStart": "Mulai pertarungan",
  "noTrophies": "Belum ada. Bos muncul di papan setelah kamu punya cukup penguasaan dan XP.",
