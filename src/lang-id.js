...
LANG.id = {
 ...
 "ui": {
  "role": "Peran",
  "streak": "Streak",
  "freePlay": "Kamu sudah menguasai semuanya. Papan sekarang adalah latihan bebas.",
  "locked": "Terkunci: capai 60% di {p} untuk membuka.",
  ...
  "colStatus": "Status",
  "stM": "Dikuasai",
  "recLocked": "Masih terkunci: {s}. Terbuka jika prasyarat lolos 60%.",
  "bloomAcc": "Akurasi berdasarkan level Bloom",
  "data": "Datamu",
  "setH": "Pengaturan",
  "uiLang": "Bahasa game",
  "balance": "Saldo",
  ...
  "modes": {
   ...
   "medio": "Sedang",
   "dificil": "Sulit",
   "hardcore": "Sangat hardcore"
  },
  "typedPh": "output program",
  ...
  "bossRules": "Tiga tahap berantai, tanpa petunjuk dan tanpa power-up. Kamu boleh melakukan satu kesalahan. Kesulitan yang dipilih di papan berlaku juga di sini.",
  "trophies": "Trofi",
  "equip": "Gunakan gelar ini",
  "evoP": "Setiap garis adalah estimasi penguasaan satu keterampilan di semua tiket yang kamu jawab. Ketuk keterampilan untuk menyorotnya: titik hijau adalah jawaban benar dan titik kuning adalah kesalahan. Garis putus-putus menandai pembukaan (60%) dan penguasaan ({m}).",
  "models": {
   "elo": "Elo/Rasch",
   "irt": "IRT 3PL dengan EAP",
   "bkt": "BKT",
   "pfa": "PFA",
   "afm": "AFM"
  },
  "cmpH": "Perbandingan model pada riwayat ini",
  "confirmTag": "Konfirmasi",
  "studentName": "Nama siswa (opsional, ditampilkan pada laporan tercetak)",
  "homeLangs": "bahasa",
  "homePls": "bahasa pemrograman",
  "runErr": "Kode tidak berjalan, jadi skornya 0: {e}",
  "hidden": "Kasus tersembunyi: {a} dari {b} benar. Kasus ini ada agar solusinya benar-benar berfungsi, tidak hanya untuk contoh yang terlihat.",
  "codeEmpty": "Belum ada latihan kode yang dijawab.",
  "teacherP": "Pengaturan teknis. Pemain tidak perlu mengubah apa pun di sini.",
  "runnerP": "JavaScript dan Python berjalan di browser itu sendiri. Java dan C membutuhkan server yang mengompilasi dan menjalankan kode; tanpa server, latihan kode dalam bahasa tersebut disembunyikan. Gunakan server Piston milikmu sendiri, atau API publik Piston, yang sejak Februari 2026 memerlukan token yang diberikan kepada proyek pendidikan non-komersial.",
  "navLab": "Bengkel",
  "freeNote": "Tantangan bebas: ambil jalur mana pun yang kamu suka. Kasus uji yang menentukan.",
  "ruleN": {
   "noMul": "tanpa operator *",
   "useFor": "menggunakan for",
   "noPow": "tanpa pangkat bawaan (**, pow)",
   "useLoop": "menggunakan loop",
   "noMax": "tanpa max atau pengurutan bawaan",
   "noSum": "tanpa sum bawaan (sum, reduce, stream)",
   "noMod": "tanpa operator %",
   "useCond": "menggunakan kondisi",
   "noRev": "tanpa pembalikan bawaan (reverse, [::-1], StringBuilder)",
   "noEval": "tanpa eval",
   "noLoop": "tanpa for atau while",
   "selfCall": "memanggil dirinya sendiri"
  },
  "kindRule": "dengan batasan",
  "navBoard": "Papan",
  "roles": [
   "Magang",
   "Junior",
  ...
  "recBloom": "Tingkat kognitif dengan kesalahan terbanyak: {b} ({c} dari {n}). Latih tiket semacam ini dengan tenang, tanpa petunjuk.",
  "howA": "ini seperti rating catur. Mengalahkan lawan kuat bernilai banyak, mengalahkan lawan lemah bernilai sedikit, dan kalah dari lawan lemah merugikan. Di sini lawannya adalah tiket.",
  "base": "URL dasar",
  "clear": "Hapus kunci",
  "saved": "Pengaturan disimpan.",
  "keyNote": "Kunci hanya disimpan di peramban ini (localStorage) dan dikirim langsung ke penyedia. Jangan gunakan di komputer bersama. Untuk penggunaan kelas, lebih baik pakai server lokal (misalnya, Ollama di http://localhost:11434/v1), yang tidak memerlukan kunci.",
  "navShop": "Toko",
  "bountiesH": "Tantangan sprint",
  "dailyH": "Tantangan harian",
  "dailyDone": "Tantangan harian selesai. Yang baru akan datang besok.",
  "bossStage": "Tahap {n} dari {m}",
  "bossWin": "Bos dikalahkan",
  "reward": "Hadiah: {x} XP",
  "shopA": "ini seperti miles program loyalitas. Kamu membelanjakan saldo untuk tiket; tingkat kartumu bergantung pada total miles yang diterbangkan dan tidak turun saat kamu menukarkannya.",
  "equipped": "Sedang dipakai",
  "keepGoing": "Tiket ini akan kembali ke papan nanti untuk pertandingan ulang.",
  "streakMsg": "{n} kali berturut-turut! Bonus rentetan: +5 XP.",
  "colTries": "Tiket",
  "plA": "seseorang yang mengendarai mobil manual tidak kembali ke awal saat memakai mobil otomatis, tetapi tetap perlu beberapa putaran di sekitar blok untuk membuktikan bahwa dia sudah beradaptasi.",
  "plAcc": "Benar",
  "printBtn": "Cetak atau simpan sebagai PDF",
  "homeSbc": "14 misi ini mencakup pemrograman dan rekayasa perangkat lunak, dan masing-masing menyatakan kompetensi dari Pedoman Kurikulum SBC (2017) yang dilatih. Konsep yang sama muncul dalam empat bahasa pemrograman, dengan kunci jawaban yang sama.",
  "codeFn": "Tulis fungsi {f}. Namanya harus persis seperti itu.",
  "runBtn": "Jalankan",
  "codeH": "Latihan kode bebas",
  "colTime": "Waktu",
  "codeAuth": "Apa yang dibuktikan dan tidak: sidik jari dan stempel waktu membuktikan bahwa kode ini dikirim pada saat itu; jumlah tempel dan waktu menggambarkan prosesnya. Tidak ada yang membuktikan kepenulisan, karena semuanya dicatat di peramban siswa sendiri. Untuk penilaian berjenjang, tambahkan pekerjaan yang diawasi atau pembelaan kode itu sendiri.",
  "codeHidden": "Latihan kode bebas dalam {l} tetap tersembunyi sampai guru menyiapkan layanan eksekusi. Di Python dan JavaScript, latihan muncul seperti biasa.",
  "runnerToken": "Token otorisasi (jika layanan memerlukannya)",
  "runnerOn": "Java dan C: eksekusi aktif.",
  "labH": "Bengkel kode",
  "labLocked": "terbuka dengan misi",
  "labOk": "Tantangan terpecahkan di Bengkel!",
  "labAgain": "Kamu sudah lulus tantangan ini: tidak ada XP kali ini, hanya latihan.",
  "labNoMastery": "Di Bengkel, penguasaan keterampilan tidak berubah. Agar dihitung, selesaikan tantangan bonus di papan.",
  "tryAgain": "Coba lagi",
  "needsRunner": "membutuhkan layanan",
  "rulesH": "Aturan tantangan:",
  "rulesCap": "Jika kode berfungsi tetapi melanggar aturan, skor dibatasi pada Cukup (59%).",
  "navReport": "Laporan",
  "homeLead": "Kamu baru saja bergabung dengan Ponte, sebuah toko perangkat lunak kecil yang melayani toko roti lingkungan, klinik kesehatan, sekolah, dan koperasi pengiriman. Setiap klien datang dengan masalah nyata: kamu mendengar ceritanya, mempelajari kotak teori, dan baru setelah itu mengambil tiketnya.",
  "steps": [
   [
    "Dengarkan klien",
   ...
   [
    "Bangun kotak peralatan teorimu",
    "Konsep kunci, contoh kode dalam bahasa yang kamu pilih, dan kompetensi kurikulum SBC yang sedang dilatih."
   ],
   [
    "Selesaikan tiketnya",
    "Prediksi output, urutkan kode, cari bug, dan buat keputusan rekayasa. Setiap jawaban dilengkapi analogi praktis, dan tutor melacak penguasaanmu."
   ]
  ],
  "toReview": "untuk ditinjau",
  "areaProg": "Pemrograman",
  "mapHint": "Ketuk keterampilan untuk melihat detail. Angkanya adalah perkiraan probabilitas bahwa kamu sudah menguasainya.",
  "and": " dan ",
  "story": "Cerita",
  "snippetNote": "Cuplikan Java dan C menghilangkan kelas dan fungsi utama untuk menjaga fokus pada konsep.",
  ...
  "diff": "Kesulitan {d} dari 3",
  "hintNote": "Dengan hint, jawaban yang benar hanya mendapat setengah XP dan dianggap sebagai bukti penguasaan yang lebih lemah.",
  "up": "Naikkan",
  "notYet": "Belum kali ini",
  "roseNote": "Angkanya naik sedikit meskipun ada kesalahan karena model menganggap bahwa membaca penjelasan juga mengajarkan.",
  "toRetro": "Lihat retrospektif sprint",
  "retroSum": "{c} dari {n} tiket terselesaikan. ",
  ...
  "repSub": "Tampilan untuk siswa dan siapa pun yang mendukungnya: apa yang sudah dikuasai, di mana letak kesalahannya, dan apa yang harus dilatih selanjutnya.",
  "k2": "akurasi",
  "stL": "Terkunci",
  "showJson": "Tampilkan log JSON",
  "reset": "Hapus kemajuan",
  "model": "Model",
  "modeH": "Kesulitan",
  "yourAnswer": "Jawabanmu: {a}",
  "timeout": "Waktu habis.",
  "hintPaid": "Minta hint (biaya {c} XP)",
  "noHints": "Tidak ada hint dalam mode ini.",
  ...
  "bossFight": "Hadapi bos",
  "titlesH": "Gelar",
  "owned": "Kamu punya: {n}",
  "unequip": "Berhenti memakai",
  "sortHint": "Pilih salah satu dari dua kategori untuk setiap kartu.",
  "modelH": "Model penelusuran pengetahuan",
  "running": "Menjalankan kodemu...",
  "gotExp": "mendapat {g}, diharapkan {e}",
  "checks": "Struktur:",
  "telDone": "Catatan pengiriman ini: {p} tempel (terbesar dengan {m} karakter), {r} kali dijalankan, total {s} detik. Sidik jari kode: {h}",
  "runnerUrl": "Alamat layanan eksekusi",
  "pilotUrl": "Mode riset aktif: alamat halaman ini menetapkan {m} sebagai model penggerak. Hapus parameter ?piloto= untuk kembali ke bawaan.",
  "runnerOff": "Java dan C: tidak ada eksekusi. Latihan kode dalam bahasa-bahasa itu disembunyikan.",
  "bonusP": "Opsional. Bernilai XP ×1,5 dan dihitung menuju penguasaan keterampilan. Bagus untuk mengumpulkan XP sebelum menghadapi bos.",
  "bonusTag": "Bonus",
  "bonusXp": "Tantangan bonus: XP dikalikan 1,5.",
  "compP": "Skor rata-rata dalam tantangan bonus, memisahkan yang dengan batasan (dasar-dasar, tanpa alat siap pakai) dari yang bebas (pemecahan masalah). Workshop ditampilkan terpisah, karena itu latihan dan tidak dihitung menuju penguasaan.",
  "labStat": "{n} percobaan, terbaik {b}",
  "start": "Mulai sprint pertama",
  "sprint": "Sprint {n}",
  "todo": "Untuk dikerjakan",
  "doneSprint": "Selesai sprint ini",
  "map": "Peta penguasaan",
  "sbcH": "Kompetensi dari Kurikulum SBC (2017) dilatih di sini",
  "check": "Periksa jawaban",
  "aiFail": "Tutor AI tidak merespons. Periksa pengaturan atau gunakan petunjuk biasa.",
  "allUsed": "Semua baris sudah digunakan.",
  "options": "Pilihan",
  ...
  "k1": "tiket terjawab",
  "colHits": "Benar",
  "recNone": "Belum ada jawaban. Kerjakan beberapa tiket agar tutor punya bukti.",
  "howP": "Tutor menggunakan model Elo/Rasch. Setiap kemampuanmu punya peringkat, dan setiap tiket punya tingkat kesulitan pada skala yang sama. Selisih keduanya menentukan peluang jawaban benar; setelah kamu menjawab, peringkat naik atau turun sebanding dengan kejutan. Penguasaan yang ditampilkan adalah peluangmu menyelesaikan tiket dengan kesulitan rata-rata tanpa menebak, dan kemampuan dianggap terkuasai mulai dari {m}.",
  "aiP": "Tutor AI menulis petunjuk Socratic yang disesuaikan dan analogi segar dalam bahasa permainan, tanpa memberi tahu jawabannya. Tanpa itu, permainan menggunakan petunjuk yang ditulis oleh penulis.",
  "aiClaude": "Terhubung melalui Claude di tautan ini. Pada versi yang dipublikasikan di GitHub, tutor memerlukan kunci API.",
  "none": "Tidak ada",
  "titleLbl": "Judul",
  "modeDesc": {
   "normal": "XP ×1. Petunjuk gratis (jawaban benar dengan petunjuk mendapat setengah). Setiap kesalahan mengurangi 2 XP per level tiket.",
   "medio": "XP ×1,5. Setiap petunjuk mengurangi 5 XP. Setiap kesalahan mengurangi 4 XP per level tiket.",
   "dificil": "XP ×2. Tanpa petunjuk dan tanpa pilihan pada tiket keluaran: kamu mengetik apa yang dicetak program. Setiap kesalahan mengurangi 6 XP per level.",
   "hardcore": "XP ×3. Tanpa petunjuk, jawaban diketik, dan waktu 60 detik. Setiap kesalahan mengurangi 10 XP per level."
  },
  "lost": "Denda: -{x} XP dari saldomu.",
  "useTime": "Gunakan +30 dtk ({n})",
  "bossLives": "Kesalahan yang masih diizinkan: {n}",
  "shopP": "Tukarkan saldo XP-mu dengan power-up dan gelar. Membelanjakan saldo tidak mengurangi XP seumur hidup, yang membuka tahap dan bos.",
  "powers": "Power-up",
  "buy": "Tukarkan dengan {c} XP",
  "evoH": "Pertumbuhan pengetahuan",
  "plP": "Setiap bahasa punya pelacak penguasaan sendiri; yang sedang digunakan ditandai dengan ●. Saat pertama kali mencoba suatu bahasa, kamu mulai dari perkiraan transfer: setengah dari yang sudah ditempuh di bahasa terbaikmu. Nilai yang dicetak tebal sudah dilatih.",
  "pilot": "Model yang menggerakkan permainan",
  "rolePilot": "menggerakkan",
  "cmpNote": "Dengan sedikit jawaban dari satu siswa, angka-angka ini sangat berfluktuasi. Perbandingan yang valid menggunakan log yang diekspor dari banyak siswa, dipisah per siswa.",
  "colRole": "Peran",
  "confirmRule": "Wajibkan penguasaan dikonfirmasi dengan jawaban benar di hari lain",
  "homeMissions": "misi dengan cerita dan teori",
  "homeTickets": "tiket di bank",
  "submit": "Kirim untuk dinilai",
  "noExecP": "Latihan ini hanya bisa dinilai dengan layanan eksekusi kode, yang diatur oleh guru di Pengaturan, bagian Untuk guru dan riset. Sementara itu, pilih Python atau JavaScript di Pengaturan untuk mengerjakan latihan kode.",
  "checkN": {
   "loop": "menggunakan loop",
   "cond": "menggunakan kondisi",
   "rec": "memanggil dirinya sendiri",
   "base": "memiliki kasus dasar",
   "return": "mengembalikan nilai"
  },
  "aiStatusShort": "Tutor AI:",
  "teacherH": "Untuk guru dan riset",
  "runnerH": "Eksekusi kode",
  "infraH": "Saat ini tidak dapat dinilai.",
  "infra": {
   "semServico": "Tidak ada layanan eksekusi yang dikonfigurasi untuk bahasa ini.",
   "auth": "Layanan eksekusi menolak akses. Periksa token di Pengaturan.",
   "rede": "Layanan eksekusi tidak merespons. Periksa koneksi dan coba lagi.",
   "pyodide": "Python tidak dapat diunduh. Pertama kali memerlukan internet; periksa koneksi dan coba lagi.",
   "worker": "Browser ini tidak mengizinkan eksekusi JavaScript terisolasi. Coba browser lain.",
   "outro": "Layanan eksekusi mengembalikan kesalahan. Coba lagi sebentar lagi."
  },
  "labLangs": "Java dan C muncul di daftar bahasa setiap tantangan, tetapi hanya berjalan setelah guru mengatur layanan eksekusi.",
  "backLab": "Kembali ke Workshop",
  "homeH": "Pelajari pemrograman dan rekayasa perangkat lunak dengan memecahkan masalah orang-orang nyata",
  "todoEmpty": "Buka misi di atas untuk menerima tiketnya.",
  "lockedAria": "terkunci",
  "aiHint": "Minta petunjuk dari tutor AI",
  "tutorHint": "Petunjuk tutor: ",
  "solved": "Tiket selesai",
  "promo": "Promosi: peranmu sekarang adalah {r}.",
  "aiExplain": "Minta analogi lain dari tutor AI",
  "retroC": "Sprint yang berat. Tiket yang perlu ditinjau akan kembali ke papan nanti.",
  "stP": "Sedang berjalan",
  "noData": "tidak ada data",
  "resetConfirm": "Konfirmasi: hapus semua progres",
  "codeLang": "Bahasa pemrograman tiket",
  "aiOff": "Mati: game ini menggunakan petunjuk yang ditulis oleh penulis. Untuk menyalakannya, masukkan penyedia di bawah ini.",
  "provider": "Penyedia",
  "provAnthropic": "Anthropic (Claude)",
  "provOpenAI": "OpenAI-compatible (OpenAI, Ollama, LM Studio, dll.)",
  "key": "Kunci API",
  "save": "Simpan pengaturan tutor",
  "err": "Kesalahan",
  "dailyTag": "XP Ganda",
  "bossWinP": "Kamu mendapatkan {x} XP dan trofi \"{t}\".",
  "bossStart": "Mulai pertarungan",
  "noTrophies": "Belum ada. Bos muncul di papan saat kamu punya cukup penguasaan dan XP.",
  "kTotal": "XP seumur hidup",
  "oops": [
   "Hampir saja. Setiap pengembang merusak build sebelum memperbaikinya.",
  ...
  "comeback": "Bangkit kembali: +{x} XP karena menjawab benar tepat setelah melakukan kesalahan.",
  "evoEmpty": "Jawab beberapa tiket dalam bahasa ini untuk melihat kurva belajarmu.",
  "evoAll": "Semua",
  "colGain": "Perolehan",
  "colModel": "Model",
  "colAcc": "Akurasi",
  "printedOn": "Dibuat pada {d}",
  "homeI18n": "Game ini tersedia dalam 20 bahasa, sama dengan analisis terjemahan dan tokenisasi yang memandu proyek ini. Skrip kanan-ke-kiri didukung, dan bahasa dengan skripnya sendiri menawarkan versi romanisasi.",
  "aiDebug": "Minta bantuan tutor",
  "telLive": "Prosesmu sejauh ini: {p} tempel, {r} jalankan, {s} dtk.",
  "colPaste": "Tempel",
  "codeP": "Setiap pengiriman menyimpan skor, proses yang menghasilkannya, dan sidik jari kode yang dikirim.",
  "labP": "Latihan bebas untuk mereka yang ingin melangkah lebih jauh. Di sini kamu bisa menguji, gagal, dan mencoba lagi sebanyak yang kamu mau: penguasaan keterampilanmu tidak berubah, dan XP hanya didapat pertama kali tantangan melewati 60%. Setiap tantangan terbuka saat misi keterampilannya terbuka.",
  "labBest": "terbaik: {p}",
  "labXp": "+{x} XP karena melewati tantangan ini untuk pertama kalinya.",
  "ruleBroken": "Kode berfungsi, tetapi melanggar aturan tantangan: skor dibatasi pada Cukup.",
  "bonusH": "Tantangan bonus",
  "compH": "Profil kompetensi kode",
  "xp": "XP",
  "navSettings": "Pengaturan",
  "cont": "Lanjutkan dari tempat terakhir",
  "openBrief": "Dengarkan cerita dan pelajari teorinya",
  ...
  "retroB": "Kecepatan yang baik; tinjau kembali yang tertinggal.",
  ...
  "recHints": "Petunjuk digunakan di {p} tiket. Coba bentuk hipotesis dulu sebelum bertanya.",
  "how": "Cara menghitung penguasaan",
  "howParams": "Parameter desain, belum dikalibrasi dengan data: tiket tingkat 1, 2, dan 3 memiliki kesulitan -1.2, 0, dan +1.2 logit; kenaikan awal 1.8, menyusut setiap jawaban, dengan kesalahan berbobot 70% untuk menoleransi kekeliruan; menebak berdasarkan format (1 dari 4 untuk pilihan, 1 per baris untuk bug, 1 dari 16 saat mengklasifikasi, 5% saat mengurutkan, 3% untuk jawaban ketik, dan 50% dengan petunjuk). Terbuka di 60%, penguasaan di {m}, dikonfirmasi di hari lain. 3PL IRT, BKT, PFA, dan AFM hanya mengamati.",
  "dataP": "Progres hanya disimpan di browser ini. Log mengikuti format panjang dataset knowledge tracing (item, keterampilan, kebenaran, bahasa, bahasa pemrograman, stempel waktu).",
  ...
  "bossResult": "Lihat hasilnya",
  "bossLoseP": "Kamu kehilangan {x} XP dari saldomu. Tinjau misi terkait dan kembali lagi untuk tanding ulang.",
  "review": "Tinjau",
  "shopH": "Toko",
  "kBosses": "bos dikalahkan",
  "cheers": [
   "Bagus!",
   "Pembacaan kode hebat!",
   "Tepat, penalaran tajam!",
   "Tiket ditutup dengan gaya!"
  ],
  "need": "{n} XP lagi (biaya {c})",
  "evoX": "tiket dijawab",
  "colFirst": "Perkiraan pertama",
  "plH": "Penguasaan per bahasa pemrograman",
  "rom": "Tampilkan teks romanisasi (alfabet Latin)",
  "pilotNote": "Satu model menggerakkan permainan: menghitung penguasaan, membuka tahap, dan menyesuaikan kesulitan. Model lain berjalan di latar belakang dan hanya mencatat prediksi sebelum setiap jawaban, untuk perbandingan nanti. Persentase di samping setiap nama adalah ambang penguasaan model tersebut.",
  "roleShadow": "mengamati",
  "cmpP": "Sebelum setiap jawaban, lima model mencatat probabilitas respons benar yang mereka prediksi. Brier mengukur kesalahan prediksi (semakin rendah semakin baik); AUC mengukur apakah model memisahkan jawaban benar dari kesalahan (0.5 adalah kebetulan dan 1 sempurna).",
  "confirmNote": "Penguasaan tercapai hari ini. Untuk mengonfirmasi, jawab benar satu tiket keterampilan ini di hari lain: satu sesi mencampur pengetahuan dengan momentum.",
  "stC": "Untuk dikonfirmasi di hari lain",
  "repFor": "Siswa: {n}",
  "navHome": "Beranda",
  "homeSciH": "Cara alat ini dibuat",
  "bands": [
   "Tidak teratur",
   "Cukup",
   "Baik",
  ...
  "noExecH": "{l} tidak berjalan di dalam browser.",
  "scored": "Skor: {p} ({b})",
  "colScore": "Skor",
  "colRuns": "Jalan",
  "colHash": "Sidik jari",
  "runnerNote": "Kode Java dan C siswa dikirim ke server itu untuk dikompilasi dan dijalankan. Jika kolom kosong, tidak ada yang keluar dari browser.",
  "pilotFixed": "{m} menggerakkan permainan: menghitung penguasaan, membuka tahap, dan memilih kesulitan, dengan penguasaan dari {p}. BKT, PFA, AFM, dan 3PL IRT berjalan di latar belakang pada setiap jawaban dan hanya mencatat prediksi, untuk perbandingan di tab Laporan dan di data yang diekspor.",
  "kindFree": "gratis",
  "compEmpty": "Belum ada tantangan kode tambahan yang diselesaikan."
 },
 "sbc": {
  "CC-C.1.3": "RF-CC C.1.3: Menyelesaikan masalah menggunakan lingkungan pemrograman (Algoritma, Teknik Pemrograman, Struktur Data).",
  "ES-C.1.1": "RF-ES C.1.1: Menyelesaikan masalah yang memiliki solusi algoritmik (Algoritma, Pemrograman, Struktur Data).",
  "ES-C.6.4": "RF-ES C.6.4: Menerapkan teknologi yang akan digunakan dalam produk perangkat lunak (teknik dan paradigma pemrograman).",
  "ES-C.5.3": "RF-ES C.5.3: Menerapkan teknik dan prosedur spesifikasi kebutuhan (elisitasi, spesifikasi, validasi, dan manajemen).",
  "ES-C.4.2": "RF-ES C.4.2: Menerapkan proses konstruksi perangkat lunak (konsep dan model proses perangkat lunak).",
  "ES-C.4.4": "RF-ES C.4.4: Mengelola proyek perangkat lunak (ruang lingkup, waktu, kualitas, komunikasi, risiko, pemangku kepentingan).",
  "ES-C.6.3": "RF-ES C.6.3: Menentukan lingkungan konstruksi perangkat lunak (alat manajemen konfigurasi).",
  "ES-C.6.2": "RF-ES C.6.2: Menerapkan teknik dan prosedur verifikasi dan validasi statis dan dinamis.",
  "ES-C.7.3": "RF-ES C.7.3: Menerapkan teknik dan prosedur verifikasi dan validasi dalam sumbu Kualitas Perangkat Lunak.",
  "ES-C.6.1": "RF-ES C.6.1: Menerapkan teknik dan prosedur pengembangan perangkat lunak (prinsip desain, pola, penggunaan kembali).",
  "ES-C.6.7": "RF-ES C.6.7: Menerapkan prinsip, pola, dan praktik baik pengembangan perangkat lunak.",
  "ES-C.4.3": "RF-ES C.4.3: Menerapkan teknik dan prosedur pemeliharaan dan evolusi perangkat lunak (refactoring).",
  "ES-C.5.4": "RF-ES C.5.4: Menerapkan teknik pemodelan perangkat lunak (model statis, fungsional, dan dinamis).",
  "ES-C.7.1": "RF-ES C.7.1: Memahami atribut kualitas produk perangkat lunak dan kegunaannya.",
  "ES-C.7.2": "RF-ES C.7.2: Menerapkan mekanisme pengukuran kualitas produk perangkat lunak (metrik dan teknik evaluasi).",
  "ES-C.6.5": "RF-ES C.6.5: Menerapkan teknik untuk mengintegrasikan bagian-bagian sistem (lingkungan integrasi, alat build)."
 },
 "skills": {
  "var": {
   "name": "Variabel",
   "about": "Menyimpan nilai, tipe data, dan operator dasar.",
   "client": "Toko roti Dona Lúcia",
   "title": "Mesin kas yang tak pernah cocok",
   "story": "Setiap malam Dona Lúcia menutup kas toko roti di buku catatan, dan angkanya tidak pernah cocok. Keponakannya membuatkan lembar kerja, tetapi harga roti diketik sebagai teks, dan saat menambahkan dua roti hasilnya menjadi \"4.504.50\". Dia meminta sesuatu yang sederhana: mencatat harga, jumlah, dan kembalian tanpa kesalahan. Sebelum ada layar yang cantik, sistem harus menyimpan setiap data dengan tipe yang tepat.",
   "theory": [
    [
     "Variabel adalah nama untuk sebuah nilai",
     "Variabel menyimpan sepotong data di memori untuk digunakan nanti. Penugasan menyalin nilai pada saat itu; tidak membuat tautan permanen antara dua variabel."
    ],
    [
     "Setiap nilai memiliki tipe",
     "Bilangan bulat, desimal, teks, dan boolean berperilaku berbeda. Dengan teks, + menggabungkan; dengan angka, + menambahkan. Uang membutuhkan desimal; jumlah membutuhkan bilangan bulat."
    ],
    [
     "Pembagian bilangan bulat dan sisa bagi",
     "Pembagian bilangan bulat membuang bagian desimal, dan operator % mengembalikan sisanya. Keduanya adalah dasar untuk kembalian, paritas, dan membagi ke dalam kelompok."
    ]
   ]
  },
  "cond": {
   "name": "Percabangan",
   "about": "Memilih jalannya program dengan if, else if, dan else.",
   "client": "Klinik kesehatan lingkungan",
   "title": "Antrean yang tidak bisa dilayani berdasarkan urutan kedatangan",
   "story": "Di klinik kesehatan, perawat Rosa melakukan triase di kepalanya: demam tinggi didahulukan, lansia diprioritaskan, yang lain menunggu. Saat dia tidak ada, antrean menjadi berdasarkan urutan kedatangan, dan kasus serius menunggu dua jam. Klinik ingin sistem menerapkan aturan Rosa setiap saat, termasuk kasus tepi seperti demam tepat 39 derajat.",
   "theory": [
    [
     "Kondisi adalah pertanyaan ya-atau-tidak",
     "Program mengevaluasi ekspresi boolean dan mengikuti satu jalur. Operator seperti >, >=, dan == menentukan dengan tepat di mana batasnya."
    ],
    [
     "Urutan pengujian itu penting",
     "Dalam rantai if / else if, pengujian pertama yang benar akan menang dan sisanya tidak dievaluasi. Aturan yang paling ketat harus didahulukan."
    ],
    [
     "Menggabungkan kondisi",
     "AND (dan, &&) membutuhkan keduanya benar; OR (atau, ||) membutuhkan setidaknya satu. AND dievaluasi sebelum OR; jika ragu, gunakan tanda kurung."
    ]
   ]
  },
  "loop": {
  ...
  "func": {
   ...
   "title": "Ongkos kirim dihitung di tiga tempat",
   "story": "Koperasi kurir menghitung ongkos kirim di situs web, di aplikasi, dan di spreadsheet keuangan. Saat harga per kilometer naik, seseorang hanya memperbarui dua dari tiga tempat itu, dan selama seminggu para kurir dibayar lebih rendah dari yang seharusnya. Hanya ada satu aturan; aturan itu harus tinggal di satu tempat dan dipanggil oleh semua orang.",
   "theory": [
    [
     "Fungsi adalah aturan dengan nama",
     "Fungsi menerima parameter, menjalankan langkah-langkah, dan mengembalikan hasil dengan return. Mendefinisikan sekali dan memanggil di mana pun menghilangkan salinan yang berbeda-beda."
    ],
    [
     "Return bukan mencetak",
     "Mencetak menampilkan nilai di layar; return menyerahkan nilai kepada pemanggil, yang bisa menggunakannya dalam perhitungan lain."
    ],
    [
     "Scope dan pass by value",
     "Variabel yang dibuat di dalam fungsi bersifat lokal dan lenyap saat fungsi berakhir. Angka yang dikirim sebagai argumen disalin: mengubahnya di dalam tidak mengubah yang asli."
    ]
   ]
  },
  "col": {
  ...
  "rec": {
   "name": "Rekursi",
   "about": "Fungsi yang memanggil dirinya sendiri, dan base case.",
   "client": "Kantor Notaris Distrik ke-2",
   "title": "Folder di dalam folder di dalam folder",
   "story": "Kantor notaris memindai dokumen selama 40 tahun ke dalam folder-folder bersarang tanpa kedalaman standar. Helena, sang petugas, perlu menghitung total jumlah berkas. Perulangan sederhana tidak akan cukup, karena setiap folder bisa berisi folder lain. Solusi alaminya adalah: hitung berkas di folder ini dan ulangi prosedur yang sama pada setiap subfolder.",
   "theory": [
    [
     "Masalah yang didefinisikan dalam dirinya sendiri",
     "Fungsi menyelesaikan sebagian kecil dan mendelegasikan sisanya ke pemanggilan dirinya sendiri pada masalah yang lebih kecil."
    ],
    [
     "Base case: rem",
     "Ini adalah situasi sederhana yang dijawab tanpa pemanggilan baru (folder kosong, n sama dengan 0). Setiap panggilan rekursif harus bergerak ke arahnya."
    ],
    [
     "Call stack",
  ...
  "req": {
   "name": "Requirements",
   "about": "Menemukan dan menulis apa yang harus dilakukan perangkat lunak.",
   "client": "Klinik kesehatan lingkungan",
   "title": "\"Saya ingin aplikasi\"",
   "story": "Direktur klinik tiba di pertemuan dengan tekad: \"Saya ingin aplikasi seperti milik bank\". Setelah setengah jam percakapan, masalah sebenarnya muncul: pasien melewatkan janji karena lupa tanggal, dan 30% slot terbuang sia-sia. Mungkin solusinya adalah pengingat teks sederhana. Siapa pun yang membangun apa yang diminta, tanpa memahami apa yang dibutuhkan, mengirimkan perangkat lunak yang salah tepat waktu.",
   "theory": [
    [
     "Kebutuhan datang sebelum solusi",
     "Klien menjelaskan solusi; insinyur menyelidiki masalah di baliknya dengan wawancara, observasi, dan prototipe (elisitasi)."
    ],
    [
     "Fungsional dan non-fungsional",
     "Fungsional adalah apa yang dilakukan sistem (menjadwalkan, mengingatkan). Non-fungsional adalah seberapa baik sistem melakukannya (waktu respons, keamanan, ketersediaan)."
    ],
    [
     "Requirement yang baik dapat diverifikasi",
     "\"Cepat\" dan \"ramah\" tidak dapat diuji. \"Merespons dalam 2 detik untuk 95% kueri\" dapat diuji. User story mengikuti: Sebagai [peran], saya ingin [aksi], sehingga [manfaat]."
    ]
   ]
  },
  "agil": {
   "name": "Agile",
   "about": "Sprint, MVP, dan pengiriman bertahap.",
   "client": "Sekolah Negeri Paulo Freire",
   "title": "Pendaftaran dibuka enam minggu lagi",
   "story": "Sekolah menginginkan sistem pendaftaran lengkap, dengan rapor, makanan, dan transportasi. Pendaftaran dibuka enam minggu lagi, dan daftar keinginan akan memakan waktu enam bulan. Jika tim menghilang dan kembali hanya ketika semuanya siap, itu akan terlambat. Jalan keluarnya adalah mengirimkan bagian penting yang berfungsi terlebih dahulu, pendaftaran, dan berkembang dari penggunaan nyata.",
   "theory": [
    [
     "Kirim dalam siklus pendek",
     "Sebuah sprint memiliki panjang tetap dan berakhir dengan peningkatan yang dapat digunakan. Umpan balik dari pengguna nyata memandu siklus berikutnya."
    ],
    [
     "MVP: belajar lebih awal",
     "Produk minimum yang layak menyelesaikan masalah inti dari ujung ke ujung, dalam skala kecil, untuk memvalidasi hipotesis sebelum berinvestasi lebih banyak."
    ],
    [
     "Lingkup adalah variabel penyesuaian",
     "Tenggat waktu dan kualitas tetap; apa yang masuk dinegosiasikan. Membatasi pekerjaan yang sedang berjalan membantu tim menyelesaikan sebelum memulai yang baru."
    ]
   ]
  },
  "git": {
  ...
  "test": {
   ...
   "client": "Toko roti Dona Lúcia",
   "title": "Diskon yang malah membuat bayar lebih",
   "story": "Toko roti meluncurkan diskon 10% untuk pembelian mulai dari 50 reais. Seorang pelanggan belanja tepat 50 dan tidak mendapat diskon; pelanggan lain mendapat diskon dua kali. Dona Lúcia mengembalikan uang sepanjang minggu. Kesalahannya ada pada perbandingan batas yang tidak diuji siapa pun. Tes otomatis tiga baris akan membunyikan alarm sebelum pelanggan menyadarinya.",
   "theory": [
    [
     "Tes unit",
     "Memeriksa unit kecil yang terisolasi, seperti sebuah fungsi, dengan cepat dan dapat diulang. Polanya adalah Arrange, Act, Assert."
    ],
    [
     "Nilai batas",
     "Cacat sering berkumpul di batas aturan. Uji tepat di bawah, tepat di, dan tepat di atas batas."
    ],
    [
     "Tes regresi dan batas pengujian",
     "Setiap bug yang diperbaiki mendapat tes yang mereproduksinya, agar tidak pernah kembali. Tes menunjukkan adanya cacat, tetapi tidak membuktikan ketiadaannya."
    ]
   ]
  },
  "design": {
   "name": "Desain",
   "about": "Kohesi, coupling, SOLID, dan refactoring.",
   "client": "Koperasi pengiriman Roda Viva",
   "title": "Satu metode pembayaran lagi, satu tambalan lagi",
   "story": "Koperasi awalnya menerima tunai; lalu kartu, kemudian Pix, sekarang voucher makan. Setiap ada yang baru, seseorang menambahkan satu lagi \"if\" ke fungsi 300 baris yang ditakuti semua orang. Setelah perubahan terakhir, Pix tidak berfungsi selama dua hari. Perangkat lunaknya berjalan, tapi biaya perubahannya menjadi mahal. Itu masalah desain.",
   "theory": [
    [
     "Kohesi tinggi, coupling rendah",
     "Setiap modul menangani satu hal dan sedikit bergantung pada modul lain. Dengan begitu modul bisa dipahami, diuji, dan diganti secara terpisah."
    ],
    [
     "Prinsip SOLID",
     "Tanggung jawab tunggal: satu alasan untuk berubah. Terbuka/tertutup: perluas tanpa mengubah yang sudah berfungsi. Dependency inversion: bergantung pada antarmuka, bukan implementasi konkret."
    ],
    [
     "Refactoring",
     "Memperbaiki struktur tanpa mengubah perilaku, dalam langkah kecil yang dilindungi tes: ekstrak fungsi, hilangkan duplikasi, beri nama yang jelas."
    ]
   ]
  },
  "model": {
   ...
   "client": "Perpustakaan komunitas Casa das Letras",
   "title": "Tiga orang, tiga sistem di kepala",
   "story": "Sebelum membuat kode peminjaman, tim duduk bersama Pak Antônio, seorang relawan, dan seorang pembaca. Masing-masing menggambarkan \"sistemnya\", dan itu terdengar seperti tiga produk yang berbeda: bagi yang satu, sebuah buku punya beberapa eksemplar; bagi yang lain, setiap eksemplar adalah buku. Tidak ada yang salah; yang hilang adalah gambaran bersama. Sebuah diagram sederhana di dinding menyelesaikan dalam dua puluh menit apa yang tidak selesai dalam tiga rapat.",
   "theory": [
    [
     "Model adalah penyederhanaan dengan tujuan",
     "Diagram hanya menunjukkan apa yang penting untuk menjawab satu pertanyaan: siapa memakai apa, data apa yang ada, dalam urutan apa hal terjadi. Ini menyelaraskan orang sebelum ada kode."
    ],
    [
     "Tiga sudut pandang yang saling melengkapi",
     "Use case menunjukkan siapa melakukan apa (pandangan fungsional). Class diagram menunjukkan konsep dan hubungannya (pandangan statis). Sequence diagram menunjukkan pesan yang dipertukarkan seiring waktu (pandangan dinamis)."
    ],
    [
  ...
  "devops": {
   ...
   "about": "Integrasi dan pengiriman berkelanjutan, lingkungan yang dapat direproduksi, dan rollback.",
   "client": "Koperasi pengiriman Roda Viva",
   "title": "\"Di komputer saya sih jalan\"",
   "story": "Versi baru aplikasi berjalan sempurna di laptop Bia. Di server rusak: versi bahasa berbeda, pustaka hilang, pengaturan terlupa. Rilis adalah ritual manual 23 langkah yang ditulis di buku catatan, dilakukan dini hari sebulan sekali, selalu dengan rasa takut. Tim ingin rilis menjadi bukan kejadian istimewa: otomatis, dapat diulang, dan dapat dikembalikan.",
   "theory": [
    [
     "Continuous integration (CI)",
     "Setiap kali push, server membangun proyek dari nol dan menjalankan semua tes. Jika ada yang rusak, tim tahu dalam hitungan menit, saat perbaikannya masih murah."
    ],
    [
     "Continuous delivery (CD)",
     "Proses otomatis yang sama membawa perangkat lunak sampai ke produksi: build, tes, pengemasan, dan rilis. Langkah manual menjadi skrip, dan yang dapat diulang tidak lagi menakutkan."
    ],
    [
     "Lingkungan identik dan cara kembali cepat",
     "Dependensi yang dideklarasikan dalam file dan lingkungan standar mengakhiri \"di komputer saya sih jalan\". Rilis kecil dan sering dengan rollback siap pakai meminimalkan kerusakan dari setiap kesalahan."
    ]
   ]
  }
 },
 "items": {
  ...
  "c1": {
   ...
   "prompt": "Aturan batas triase. Apa yang dicetak program?",
   "hint": ">= berarti lebih besar dari ATAU sama dengan.",
   "why": "7 >= 7 bernilai benar, jadi hanya blok pertama yang dijalankan dan else dilewati.",
   "analogy": "if/else adalah percabangan jalan: mobil hanya mengambil satu sisi, tidak pernah keduanya."
  },
  "c2": {
  ...
  "c4": {
   ...
   "prompt": "Apakah hasil ekspresi ini benar atau salah?",
   "opts": [
    "Benar",
    "Salah",
    "Error",
   ...
   "hint": "Sama seperti perkalian dihitung sebelum penjumlahan, salah satu operator logika dievaluasi lebih dulu.",
   "why": "AND lebih diutamakan daripada OR. Pertama false AND false menghasilkan false; lalu true OR false menghasilkan true. Ini berlaku di keempat bahasa dalam game.",
   "analogy": "Seperti 2 + 3 × 0: kamu hitung perkaliannya dulu. AND adalah perkalian dalam logika; kalau ragu, gunakan tanda kurung."
  },
  "c5": {
   "title": "Enam puluh tanpa diskon",
   "prompt": "Orang yang berusia tepat 60 tahun seharusnya membayar setengah harga, tetapi malah membayar penuh. Baris mana yang perlu diperbaiki?",
   "hint": "Uji di kepalamu dengan angka 60: apakah kondisinya benar?",
   "why": "60 > 60 adalah salah. Aturan \"mulai 60\" membutuhkan >=. Kesalahan batas termasuk yang paling umum dalam kondisional.",
   "analogy": "Ini seperti papan \"tinggi minimal 1,40 m\" dengan penjaga yang menghentikan siapa pun yang tepat setinggi 1,40 m. Aturannya benar; perbandingannya yang salah."
  },
  "l1": {
   "title": "Dari mana penghitungan dimulai",
   "prompt": "Nilai apa saja yang dicetak oleh loop?",
   "hint": "Penghitungan dimulai dari 0 dan berhenti sebelum 3.",
   "why": "Loop menghasilkan 0, 1, dan 2: tiga nilai, dimulai dari nol dan tidak termasuk 3.",
   "analogy": "Seperti lantai gedung yang dimulai dari lantai dasar (0): tiga lantai berarti dari 0 sampai 2."
  },
  "l2": {
   "title": "Menjumlahkan nilai",
   "prompt": "Apa yang dicetak oleh program?",
   "hint": "Loop mencakup 1 dan tidak termasuk 5.",
   "why": "Loop melewati 1, 2, 3, dan 4, dan jumlahnya 10. Batas atas tidak diikutsertakan.",
   "analogy": "total adalah celengan: setiap putaran memasukkan koin senilai i. Di akhir, kamu hitung isinya."
  },
  "l3": {
   "title": "Hitung mundur tanpa akhir",
   "prompt": "Kode seharusnya mencetak 3, 2, 1 lalu \"selesai\", tetapi tidak pernah berhenti. Baris mana yang perlu diperbaiki?",
   "hint": "Agar loop berhenti, n > 0 harus menjadi salah pada suatu titik.",
   "why": "Menambah 1 menjauhkan n dari nol, sehingga kondisinya selalu benar. Perbaikannya adalah mengurangi 1.",
   "analogy": "Ini seperti menuruni tangga dengan cara naik satu anak tangga setiap kali: kamu tidak akan pernah sampai di lantai bawah. Setiap while harus bergerak menuju pintu keluar."
  },
  "l4": {
   "title": "Nilai tertinggi di kelas",
   "prompt": "Marta ingin nilai tertinggi dalam daftar. Susun programnya.",
   "hint": "Mulai dengan menganggap elemen pertama sebagai yang tertinggi; lalu bandingkan dengan setiap elemen.",
   "why": "Polanya: tebakan awal (elemen pertama), telusuri semuanya, ganti juara saat ada yang lebih tinggi, dan cetak hanya setelah loop selesai.",
   "analogy": "Ini seperti \"raja bukit\": orang pertama naik ke puncak dan setiap penantang hanya mengambil alih jika lebih tinggi. Siapa pun yang ada di sana di akhir adalah nilai maksimum."
  },
  "l5": {
   "title": "Berapa kali bisa dibagi dua",
   "prompt": "Apa yang dicetak oleh program?",
   "hint": "Ikuti n setiap putaran: 16, 8, ...",
   "why": "n melewati 8, 4, 2, dan 1: empat kali pembagian sampai n > 1 menjadi salah.",
   "analogy": "Melipat selembar kertas menjadi dua berulang kali: while tidak tahu sebelumnya berapa kali lipatan akan terjadi; ia berhenti saat tidak mungkin lagi."
  },
  "f1": {
   "title": "Menggunakan nilai kembalian",
   "prompt": "Apa yang dicetak oleh program?",
   "hint": "return memberikan hasil kepada siapa pun yang memanggil fungsi.",
   "why": "Fungsi mengembalikan 8, disimpan di r. Lalu 8 + 1 = 9.",
   "analogy": "Fungsi adalah pembuat jus: buah masuk (argumen) dan segelas jus keluar (nilai kembalian), yang bisa kamu gunakan sesukamu."
  },
  "f2": {
  ...
  "q1": {
   ...
   "opts": [
    ...
    "Sistem mengirim pengingat teks",
    "Resepsionis mendaftarkan pasien"
   ],
  ...
  "q3": {
   ...
   "prompt": "Pilihan mana yang mengikuti format user story?",
   "opts": [
    "Sebagai pasien, saya ingin pengingat sehari sebelumnya, supaya saya tidak melewatkan janji temu",
    "Buat tabel janji temu dengan kunci asing ke pasien",
    "Sistem harus menggunakan React di front end",
    "Layar penjadwalan, versi 2"
   ],
   "hint": "Formatnya adalah: Sebagai [peran], saya ingin [tindakan], supaya [manfaat].",
   "why": "Cerita tersebut menyebutkan siapa yang membutuhkan, apa yang dibutuhkan, dan mengapa, tanpa mendikte solusi teknis.",
   "analogy": "Ini seperti memesan di restoran: pelanggan menyebutkan hidangan dan rasa lapar yang ingin dipenuhi, bukan merek wajan yang harus dipakai koki."
  },
  "q4": {
   "title": "\"Seperti punya bank\"",
   "prompt": "Direktur meminta \"aplikasi seperti punya bank\". Apa langkah pertama terbaik?",
   "opts": [
    "Tanyakan masalah sehari-hari apa yang ingin ia selesaikan",
    "Mulai membangun aplikasi segera",
    "Menolak, karena aplikasi mahal",
    "Perkirakan tenggat waktu dan bicarakan nanti"
   ],
   "hint": "Dia menggambarkan solusi. Apa kebutuhan di baliknya?",
   "why": "Permintaan biasanya datang sebagai solusi. Memahami kebutuhan sebenarnya (janji temu terlewat) bisa mengungkap hal yang lebih sederhana dan berguna.",
   "analogy": "Pasien datang meminta antibiotik; dokter yang baik pertama-tama bertanya apa yang dirasakan."
  },
  "q5": {
   "title": "Validasi sebelum membangun",
   "prompt": "Teknik mana yang memvalidasi kebutuhan dengan resepsionis klinik sebelum ada coding?",
   "opts": [
    "Tunjukkan prototipe kertas dari layar dan amati mereka menggunakannya",
    "Serahkan sistem jadi dan kumpulkan keluhan",
    "Kirim dokumen kebutuhan lewat email dan tunggu",
    "Tanya hanya kepada direktur apakah semuanya baik-baik saja"
   ],
   "hint": "Cari opsi termurah yang menempatkan pengguna nyata di depan ide.",
   "why": "Prototipe sederhana hanya butuh beberapa menit dan mengungkap kesalahpahaman lebih awal, selagi perbaikannya masih murah.",
   "analogy": "Penjahit melakukan pengepasan dengan jarum pentul sebelum menjahit. Memindahkan jarum butuh detik; membuka jahitan bisa merusak jas."
  },
  "a1": {
   "title": "Apa itu sprint",
   "prompt": "Dalam Scrum, sprint adalah:",
   "opts": [
    "Siklus pendek berdurasi tetap yang menghasilkan increment yang dapat digunakan",
    "Tahap pengujian akhir sebelum peluncuran",
    "Pertemuan harian 15 menit",
    "Dokumen berisi semua kebutuhan proyek"
   ],
   "hint": "Pikirkan ritme: siklus berulang dengan hasil di akhir.",
   "why": "Sprint punya durasi tetap (biasanya 1 sampai 4 minggu) dan berakhir dengan sesuatu yang berfungsi dan bisa dievaluasi.",
   "analogy": "Seperti game ini: setiap 5 tiket kamu berhenti, lihat apa yang sudah dikirim, dan sesuaikan arah, alih-alih menilai semuanya hanya di akhir."
  },
  "a2": {
   "title": "Untuk apa daily",
   "prompt": "Apa tujuan dari pertemuan harian?",
   "opts": [
    "Menyinkronkan tim dan mengungkap hambatan",
    "Laporan individual kepada manajemen",
    "Menjelaskan solusi teknis setiap tugas",
    "Merencanakan ulang seluruh product backlog"
   ],
   "hint": "Durasinya sekitar 15 menit. Apa yang muat dalam waktu itu?",
   "why": "Daily menyelaraskan tim menuju tujuan sprint dan mengungkap hambatan lebih awal. Diskusi panjang dilanjutkan setelahnya, hanya dengan yang terlibat.",
   "analogy": "Ini adalah briefing cepat tim saat jeda: siapa menjaga siapa dan di mana masalahnya. Pembicaraan seluruh tim untuk momen lain."
  },
  "a3": {
   "title": "MVP pendaftaran",
   "prompt": "Apa MVP yang baik untuk sekolah?",
   "opts": [
    "Pendaftaran online berfungsi end to end, tanpa rapor atau makanan",
    "Semua layar didesain tapi tidak ada yang berfungsi",
    "Sistem lengkap, dikirim dalam enam bulan",
    "Hanya databasenya, tanpa layar sama sekali"
   ],
   "hint": "MVP adalah versi terkecil yang sudah menyelesaikan masalah inti untuk pengguna nyata.",
   "why": "MVP memberikan nilai end to end dalam skala kecil dan memungkinkan belajar dari penggunaan nyata sebelum berinvestasi sisanya.",
   "analogy": "Seseorang yang ingin bepergian dari A ke B tidak menerima roda dulu lalu sasis. Mereka mendapat skateboard, lalu sepeda, lalu mobil: setiap tahap sudah bisa membawa mereka."
  },
  "a4": {
   "title": "Tidak muat di sprint",
   "prompt": "Dua hari sebelum sprint berakhir, tim menyadari tidak akan mengirim semuanya. Apa langkah terbaik?",
   "opts": [
    "Menegosiasikan ulang cakupan dengan Product Owner, menjaga kualitas",
    "Melewatkan pengujian untuk mengirim semuanya",
    "Memperpanjang sprint tanpa memberi tahu siapa pun",
    "Lembur diam-diam sampai muat"
   ],
   "hint": "Dalam agile, tenggat dan kualitas tetap. Apa yang fleksibel?",
   "why": "Cakupan adalah variabel penyesuaian. Mengurangi kualitas menciptakan utang teknis, dan menyembunyikan masalah merusak transparansi.",
   "analogy": "Restoran penuh: lebih baik menghapus satu hidangan dari menu malam ini daripada menyajikan ayam mentah ke setiap meja."
  },
  "a5": {
   "title": "Semua dimulai, tidak ada yang selesai",
   "prompt": "Papan tim punya 12 tugas \"dalam proses\" untuk 3 orang, dan tidak ada yang selesai. Praktik Kanban mana yang mengatasi ini?",
   "opts": [
    "Membatasi pekerjaan yang sedang berjalan (WIP)",
    "Menambah kolom pada papan",
    "Mengadakan rapat lebih lama",
    "Membuat sprint lebih lama"
   ],
   "hint": "Kemacetannya bukan memulai; melainkan menyelesaikan.",
  ...
  "x11": {
   "title": "Jumlah digit, tanpa pengulangan",
   "prompt": "Tulis digit_sum(n), yang mengembalikan jumlah digit dari n (nol atau lebih) menggunakan rekursi. for dan while tidak boleh digunakan.",
   "hint": "Digit terakhir adalah n % 10; sisa angkanya adalah n dibagi 10, tanpa bagian desimal.",
   "why": "Tanpa pengulangan, perulangannya berasal dari fungsi itu sendiri. Basis kasus (angka satu digit) yang membuat panggilan berhenti.",
   "analogy": "Ini seperti mengupas bawang: kamu mengambil satu lapis, melihat sisanya, dan ulangi sampai ke intinya."
  },
  "x12": {
   "title": "Detik di jam",
   "prompt": "Tulis hms(detik), yang mengubah jumlah detik menjadi format \"hh:mm:ss\", selalu dengan dua digit di setiap bagian.",
   "hint": "Jam adalah detik dibagi 3600; menit berasal dari sisa setelah jam, dibagi 60.",
   "why": "Setiap bagian berasal dari sisa bagian sebelumnya: pemikiran yang sama seperti memberi kembalian dengan uang terbesar dulu. Nol di depan adalah format, bukan perhitungan.",
   "analogy": "Ini seperti memberi kembalian dengan lembaran uang paling sedikit: pertama ratusan, lalu puluhan, dan sisanya dalam koin."
  },
  "w1": {
   "title": "Biaya kirim koperasi",
   "prompt": "Tulis fungsi pengiriman: 5 reais tetap ditambah 2 reais per kilometer.",
   "hint": "Satu baris saja cukup: kembalikan hasil perhitungannya, jangan cetak.",
   "why": "Aturannya menjadi fungsi bernama yang bisa dipanggil dari situs web, aplikasi, dan lembar kerja tanpa salinan yang berbeda-beda.",
   "analogy": "Ini seperti daftar harga di dinding: hanya satu, dan semua orang membaca yang sama."
  },
  "w2": {
   "title": "Menjumlahkan daftar penjualan",
   "prompt": "Tulis fungsi yang menjumlahkan semua nilai dalam daftar dan mengembalikan totalnya. Dengan daftar kosong, totalnya nol.",
   "hint": "Mulai dengan akumulator nol dan telusuri daftar sambil menambahkan.",
   "why": "Ini adalah pola akumulator: nilai netral di awal, satu penambahan per putaran, hasil dikembalikan setelah perulangan.",
   "analogy": "Ini seperti celengan: mulai kosong, menerima satu koin pada satu waktu, dan hanya di akhir kamu menghitung isinya."
  },
  "w3": {
   "title": "Triase klinik",
   "prompt": "Tulis fungsi triase: 39 atau lebih mengembalikan \"merah\"; dari 37,5 sampai 38,9 mengembalikan \"kuning\"; di bawah 37,5 mengembalikan \"hijau\".",
   "hint": "Aturan paling serius didahulukan, dan setiap pasien keluar dengan satu tingkat saja.",
   "why": "Rantai kondisi menjamin satu hasil per pasien. Nilai batasnya, 39 dan 37,5, tepat di situlah kesalahan muncul.",
   "analogy": "Ini seperti protokol di dinding klinik: dibaca dari atas ke bawah, berhenti di baris pertama yang berlaku."
  },
  "w4": {
   "title": "Berapa banyak yang melewati batas",
   "prompt": "Tulis fungsi yang menghitung berapa banyak nilai dalam daftar yang lebih besar dari batas yang diberikan.",
   "hint": "Penghitung sebelum perulangan, kondisi di dalamnya, hasilnya setelahnya.",
   "why": "Menghitung berbeda dengan menjumlahkan: penghitung bertambah satu per satu, berapa pun besar nilainya. Lebih besar dari batas mengecualikan nilai yang sama dengan batas itu.",
   "analogy": "Ini seperti penjaga pintu dengan alat hitung klik: satu klik per orang yang memenuhi aturan."
  },
  "w5": {
   "title": "Faktorial, tanpa perulangan",
   "prompt": "Tulis fungsi faktorial menggunakan rekursi. Faktorial dari 0 adalah 1.",
   "hint": "Tangani kasus dasar terlebih dahulu; lalu kembalikan n dikali faktorial dari n dikurangi 1.",
   "why": "Tanpa kasus dasar, fungsi akan memanggil dirinya sendiri selamanya. Dengan itu, setiap panggilan bergerak menuju nol dan jawabannya kembali sambil mengalikan.",
   "analogy": "Ini seperti boneka Rusia: kamu berhenti pada yang padat dan kembali menutupnya satu per satu."
  },
  "w6": {
   "title": "Uang kembalian toko roti",
   "prompt": "Tulis fungsi yang mengembalikan kembalian: berapa sisa dari jumlah yang dibayar setelah dikurangi harga.",
   "hint": "Satu pengurangan dan satu pengembalian. Harga dan yang dibayar datang sebagai parameter.",
   "why": "Kedua nilai datang dari luar, fungsi mengembalikan hasilnya dan tidak mencetak apa pun: dengan begitu ia melayani mesin kasir, struk, dan laporan.",
   "analogy": "Ini seperti kalkulator di meja kasir: ia menerima dua angka, menunjukkan selisihnya, dan tidak menyimpan apa pun untuk dirinya sendiri."
  },
  "x1": {
   "title": "Mengalikan tanpa mengalikan",
   "prompt": "Tulis mult(a, b), yang mengembalikan a dikali b, hanya menggunakan penjumlahan di dalam perulangan for. Operator * tidak boleh digunakan. Asumsikan b nol atau lebih.",
   "hint": "Mengalikan 3 dengan 4 sama dengan menambahkan 3 sebanyak empat kali.",
   "why": "Perkalian adalah penjumlahan berulang. Menulis perulangannya menunjukkan bahwa kamu memahami apa yang dilakukan operator di balik layar, dan kasus ketika b nol menguji apakah akumulator dimulai di tempat yang tepat.",
   "analogy": "Ini seperti menghitung setumpuk empat koin yang masing-masing bernilai tiga: kamu menambahkan dengan kelipatan tiga."
  },
  "x2": {
   "title": "Pangkat langkah demi langkah",
   "prompt": "Tulis power(base, exp), yang mengembalikan base dipangkatkan exp, dengan exp nol atau lebih. Jangan gunakan ** atau fungsi pangkat bawaan.",
   "hint": "Mulai dari 1 dan kalikan dengan base, sebanyak exp kali.",
   "why": "Pangkat adalah perkalian berulang, sama seperti perkalian adalah penjumlahan berulang. Akumulator dimulai dari 1, elemen netral perkalian, dan itulah yang membuat exp sama dengan nol mengembalikan 1.",
   "analogy": "Ini seperti melipat selembar kertas: setiap lipatan menggandakan lapisannya, dan tanpa lipatan sama sekali kamu punya satu lapisan."
  },
  "x3": {
   "title": "Yang terbesar dalam daftar",
   "prompt": "Tulis fungsi largest(values), yang mengembalikan nilai terbesar dari daftar yang tidak kosong. Jangan gunakan max atau mengurutkan daftar.",
   "hint": "Simpan elemen pertama sebagai yang terbesar sejauh ini, lalu bandingkan dengan setiap elemen lainnya.",
   "why": "Ini adalah pola juara sementara. Memulai dari elemen pertama, bukan dari nol, membuat daftar berisi angka negatif tetap berfungsi.",
   "analogy": "Ini seperti lomba panco: siapa yang menang tetap di meja dan menghadapi lawan berikutnya."
  },
  "x4": {
   "title": "Rata-rata tanpa jalan pintas",
   "prompt": "Tulis fungsi average(values), yang mengembalikan rata-rata dari daftar yang tidak kosong. Jangan gunakan fungsi sum atau average bawaan.",
   "hint": "Jumlahkan semua dalam loop, lalu bagi dengan jumlah elemen.",
   "why": "Rata-rata adalah jumlah dibagi banyaknya angka. Di Java dan C, pembagian dua bilangan bulat membuang bagian desimal, jadi jumlahnya harus disimpan sebagai bilangan desimal.",
   "analogy": "Ini seperti membagi tagihan restoran: pertama jumlahkan semuanya, lalu bagi dengan jumlah orang."
  },
  "x5": {
   "title": "Genap atau ganjil, tanpa sisa bagi",
   "prompt": "Tulis fungsi parity(n), yang mengembalikan \"genap\" untuk bilangan genap dan \"ganjil\" untuk bilangan ganjil, tanpa menggunakan operator %.",
   "hint": "Bagi dengan 2 dan buang bagian desimalnya, kalikan kembali dengan 2, lalu bandingkan dengan angka aslinya.",
   "why": "Operator sisa bagi adalah jalan pintas. Membangun kembali angka dari pembagian integer menunjukkan arti sisa bagi: apa yang tersisa ketika pembagian tidak tepat.",
   "analogy": "Ini seperti membagi permen kepada dua anak: jika ada satu tersisa di tanganmu, totalnya ganjil."
  },
  "x6": {
   "title": "Dari belakang ke depan",
   "prompt": "Tulis fungsi reverse(text), yang mengembalikan teks yang dibalik. Jangan gunakan fungsi pembalik bawaan atau slicing dengan langkah negatif.",
   "hint": "Telusuri teks dan terus letakkan setiap huruf di depan hasil.",
   "why": "Membalik secara manual membutuhkan pemikiran tentang posisi setiap karakter. Teks kosong dan teks satu huruf menguji apakah loop menangani kasus tepi.",
   "analogy": "Ini seperti menurunkan tumpukan piring: yang terakhir masuk adalah yang pertama keluar."
  },
  "x7": {
   "title": "Kalkulator penghitung",
   "prompt": "Tulis fungsi calc(a, op, b), yang mengembalikan hasil dari a op b, di mana op adalah \"+\", \"-\", \"*\" atau \"/\". Jangan gunakan eval.",
   "hint": "Satu kondisi untuk setiap operasi. Di Java, bandingkan teks dengan equals, bukan dengan ==.",
   "why": "Mengubah simbol menjadi aksi adalah inti dari interpreter. Melarang eval memaksamu menangani setiap kasus, dan itu lebih aman: eval akan menjalankan apa pun yang diketik pengguna.",
   "analogy": "Ini seperti pelayan yang menerima pesanan tertulis dan memutuskan ke dapur mana membawanya: setiap simbol memiliki tujuannya."
  },
  "x8": {
   "title": "BMI dengan klasifikasi",
   "prompt": "Tulis fungsi bmi_class(weight, height), yang menghitung BMI (berat dibagi tinggi kuadrat) dan mengembalikan \"under\" di bawah 18,5; \"normal\" dari 18,5 hingga di bawah 25; \"over\" dari 25 hingga di bawah 30; \"obese\" dari 30 ke atas.",
   "hint": "Hitung BMI sekali, lalu uji rentang dari yang terendah ke tertinggi.",
   "why": "Perhitungan dan klasifikasi adalah dua langkah, dan batas tepatnya (18,5, 25, 30) menunjukkan apakah kondisi menyertakan atau mengecualikan batas. BMI adalah indikator skrining untuk populasi, bukan diagnosis individu.",
   "analogy": "Ini seperti palang pengukur tinggi di taman hiburan: pengukuran dilakukan lebih dulu, baru kemudian diputuskan wahana mana yang boleh dinaiki orang tersebut."
  },
  "x9": {
   "title": "Menghitung huruf vokal",
   "prompt": "Tulis fungsi count_vowels(text), yang mengembalikan berapa banyak huruf vokal (a, e, i, o, u) dalam teks, mengabaikan huruf besar dan kecil.",
   "hint": "Telusuri teks dan untuk setiap huruf kecil, periksa apakah itu vokal.",
   "why": "Ini adalah menghitung dengan filter: sebuah penghitung, loop, dan kondisi. Mengonversi ke huruf kecil sebelum membandingkan menghindari pengulangan aturan untuk huruf kapital.",
   "analogy": "Ini seperti inspektur pasar yang hanya menghitung kios buah: dia melewati semuanya, tetapi hanya menandai yang memenuhi aturan."
  },
  "x10": {
   "title": "FizzBuzz",
   "prompt": "Tulis fungsi fizzbuzz(n): kembalikan \"FizzBuzz\" jika n kelipatan 3 dan 5, \"Fizz\" jika hanya kelipatan 3, \"Buzz\" jika hanya kelipatan 5, dan angka itu sendiri sebagai teks jika tidak.",
   "hint": "Uji kasus paling spesifik dulu, yaitu kelipatan 15.",
   "why": "Urutan kondisi itu penting: jika pengujian untuk 3 dilakukan sebelum 15, maka 15 tidak akan pernah mencapai FizzBuzz. Ini kesalahan paling umum dalam latihan klasik ini.",
   "analogy": "Ini seperti triase yang memeriksa dulu pasien dengan kedua gejala: jika hanya gejala pertama yang ditangani, kasus lengkapnya terlewat."
  }
 },
 "game": {
  "shop": {
   "shield": [
    "Perisai",
    "Menyerap penalti XP dari kesalahanmu berikutnya. Digunakan secara otomatis."
   ],
   "fifty": [
    "Hapus dua",
   ...
   "tBug": [
    "Pemburu bug",
    "Gelar yang ditampilkan di sebelah peranmu."
   ],
   "tArch": [
    "Pikiran arsitek",
    "Gelar yang ditampilkan di sebelah peranmu."
