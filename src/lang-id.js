...
LANG.id = {
 ...
 "ui": {
  "role": "Peran",
  "streak": "Streak",
  "freePlay": "Kamu sudah menguasai semuanya. Papan sekarang menjadi latihan bebas.",
  ...
  "colStatus": "Status",
  "stM": "Dikuasai",
  "recLocked": "Masih terkunci: {s}. Akan terbuka saat prasyarat melampaui 60%.",
  ...
  "bossRules": "Tiga tahap berantai, tanpa petunjuk dan tanpa power-up. Kamu boleh membuat satu kesalahan. Tingkat kesulitan yang dipilih di papan juga berlaku di sini.",
  "trophies": "Trofi",
  "equip": "Gunakan gelar ini",
  "evoP": "Setiap baris adalah perkiraan penguasaan satu keterampilan dari tiket yang kamu jawab. Ketuk keterampilan untuk menyorotnya: titik hijau adalah jawaban benar dan titik kuning adalah kesalahan. Garis putus-putus menandai pembukaan kunci (60%) dan penguasaan ({m}).",
  "models": {
   "elo": "Elo/Rasch",
   "irt": "3PL IRT dengan EAP",
   "bkt": "BKT",
   "pfa": "PFA",
   "afm": "AFM"
  },
  ...
  "hidden": "Kasus tersembunyi: {a} dari {b} benar. Kasus ini ada agar solusi benar-benar berfungsi, bukan hanya untuk contoh yang terlihat.",
  "codeEmpty": "Belum ada latihan kode yang dijawab.",
  "teacherP": "Pengaturan teknis. Pemain tidak perlu mengubah apa pun di sini.",
  "runnerP": "JavaScript dan Python berjalan di browser itu sendiri. Java dan C memerlukan server yang mengompilasi dan menjalankan kode; tanpa itu, latihan kode dalam bahasa tersebut tetap tersembunyi. Gunakan server Piston milikmu sendiri, atau API publik Piston, yang sejak Februari 2026 memerlukan token yang diberikan kepada proyek pendidikan nonkomersial.",
  "navBoard": "Papan",
  "roles": [
   "Magang",
   "Junior",
  ...
  "recBloom": "Level kognitif dengan kesalahan terbanyak: {b} ({c} dari {n}). Latih tiket seperti ini dengan tenang, tanpa petunjuk.",
  ...
  "keyNote": "Kunci hanya disimpan di browser ini (localStorage) dan dikirim langsung ke penyedia. Jangan gunakan di komputer bersama. Untuk penggunaan di kelas, lebih baik pakai server lokal (misalnya, Ollama di http://localhost:11434/v1), yang tidak memerlukan kunci.",
  "navShop": "Toko",
  ...
  "reward": "Hadiah: {x} XP",
  "shopA": "ini seperti miles program loyalitas. Kamu membelanjakan saldo untuk tiket; tingkatan kartumu tergantung total miles yang diterbangkan dan tidak turun saat kamu menukarkannya.",
  "equipped": "Sedang dipakai",
  "keepGoing": "Tiket ini akan kembali ke papan nanti untuk pertandingan ulang.",
  "streakMsg": "{n} beruntun! Bonus rentetan: +5 XP.",
  "colTries": "Tiket",
  "plA": "seseorang yang bisa mengemudi mobil manual tidak mulai dari nol lagi di mobil otomatis, tetapi tetap perlu beberapa putaran di sekitar blok untuk membuktikan bahwa dia sudah beradaptasi.",
  "plAcc": "Benar",
  "printBtn": "Cetak atau simpan sebagai PDF",
  "homeSbc": "14 misi ini mencakup pemrograman dan rekayasa perangkat lunak, dan masing-masing menyebutkan kompetensi dari Pedoman Kurikulum SBC (2017) yang dilatihnya. Konsep yang sama muncul dalam empat bahasa pemrograman, dengan kunci jawaban yang sama.",
  "codeFn": "Tulis fungsi {f}. Namanya harus persis seperti itu.",
  "runBtn": "Jalankan",
  "codeH": "Latihan kode bebas",
  "colTime": "Waktu",
  "codeAuth": "Apa yang dibuktikan dan apa yang tidak: sidik jari dan stempel waktu membuktikan bahwa kode ini dikirimkan pada saat itu; jumlah tempel dan waktu menggambarkan prosesnya. Tidak ada yang membuktikan kepengarangan, karena semuanya dicatat di browser siswa sendiri. Untuk penilaian berjenjang, tambahkan pekerjaan yang diawasi atau pembelaan kode itu sendiri.",
  ...
  "navReport": "Laporan",
  "homeLead": "Kamu baru saja bergabung dengan Ponte, sebuah toko perangkat lunak kecil yang melayani toko roti, klinik kesehatan, sekolah, dan koperasi pengiriman di lingkungan sekitar. Setiap klien membawa masalah nyata: kamu mendengar ceritanya, mempelajari toolkit teori, dan baru kemudian mengerjakan tiketnya.",
  "steps": [
   [
    "Dengarkan klien",
    "Setiap misi dibuka dengan kisah masalah nyata, diceritakan oleh orang-orang yang mengalaminya."
   ],
   [
    "Bangun toolkit teorimu",
    "Konsep kunci, contoh kode dalam bahasa yang kamu pilih, dan kompetensi kurikulum SBC yang dilatih."
   ],
   [
    "Selesaikan tiket",
  ...
  "mapHint": "Ketuk keterampilan untuk melihat detail. Angka tersebut adalah perkiraan probabilitas bahwa kamu sudah menguasainya.",
  "and": " dan ",
  "story": "Cerita",
  "snippetNote": "Cuplikan Java dan C menghilangkan kelas dan fungsi utama agar fokus tetap pada konsep.",
  "startTickets": "Aku siap: lepaskan tiket misi ini",
  ...
  "hintNote": "Dengan petunjuk, jawaban yang benar mendapat setengah XP dan dianggap sebagai bukti penguasaan yang lebih lemah.",
  "up": "Naikkan",
  "notYet": "Belum kali ini",
  "roseNote": "Nilainya naik sedikit meskipun ada kesalahan karena model mengasumsikan bahwa membaca penjelasan juga mengajarkan.",
  "toRetro": "Lihat retrospektif sprint",
  "retroSum": "{c} dari {n} tiket diselesaikan. ",
  ...
  "repSub": "Tampilan untuk siswa dan siapa pun yang mendukung mereka: apa yang sudah dikuasai, di mana kesalahannya, dan apa yang harus dilatih selanjutnya.",
  "k2": "akurasi",
  "stL": "Terkunci",
  ...
  "bossesH": "Bos",
  "bossLocked": "Membutuhkan 60% dalam {p} dan {x} XP seumur hidup.",
  "bossDefeated": "Dikalahkan",
  "bossFight": "Hadapi bos",
  "titlesH": "Gelar",
  "owned": "Kamu memiliki: {n}",
  "unequip": "Berhenti menggunakan",
  "sortHint": "Pilih salah satu dari dua kategori untuk setiap kartu.",
  "modelH": "Model pelacakan pengetahuan",
  "running": "Menjalankan kodemu...",
  "gotExp": "mendapat {g}, diharapkan {e}",
  "checks": "Struktur:",
  "telDone": "Rekaman pengiriman ini: {p} tempel (terbesar dengan {m} karakter), {r} kali dijalankan, total {s} detik. Sidik jari kode: {h}",
  ...
  "runnerOff": "Java dan C: tidak ada eksekusi. Latihan kode dalam bahasa tersebut tetap disembunyikan.",
  ...
  "allUsed": "Semua baris sudah terpakai.",
  "options": "Pilihan",
  "codeLines": "Baris kode",
  "delta": "Penguasaan {s}: {a} ke {b}   (+{x} XP)",
  "changed": "Perubahan pada penguasaanmu",
  "k1": "tiket terjawab",
  "colHits": "Benar",
  "recNone": "Belum ada jawaban. Kerjakan beberapa tiket agar tutor punya bukti.",
  "howP": "Tutor menggunakan model Elo/Rasch. Setiap keterampilanmu punya peringkat, dan setiap tiket punya tingkat kesulitan pada skala yang sama. Selisih antara keduanya menentukan peluang jawaban benar; setelah kamu menjawab, peringkat naik atau turun sebanding dengan kejutan. Penguasaan yang ditampilkan adalah peluangmu menyelesaikan tiket dengan kesulitan rata-rata tanpa menebak, dan keterampilan dianggap dikuasai mulai dari {m}.",
  "aiP": "Tutor AI menulis petunjuk Sokrates yang disesuaikan dan analogi segar dalam bahasa permainan, tanpa membocorkan jawaban. Tanpa itu, permainan menggunakan petunjuk yang ditulis oleh penulis.",
  ...
  "modeDesc": {
   ...
   "medio": "XP ×1,5. Setiap petunjuk memerlukan 5 XP. Setiap kesalahan mengurangi 4 XP per level tiket.",
  ...
  "plP": "Setiap bahasa punya pelacak penguasaannya sendiri; yang sedang digunakan ditandai dengan ●. Saat pertama kali mencoba bahasa, kamu mulai dari perkiraan transfer: setengah dari jalan yang sudah ditempuh di bahasa terbaikmu. Nilai yang dicetak tebal sudah dilatih.",
  ...
  "noExecP": "Latihan ini hanya bisa dinilai dengan layanan eksekusi kode, yang diatur oleh guru di Pengaturan, di bagian Untuk guru dan penelitian. Sementara itu, pilih Python atau JavaScript di Pengaturan untuk mengerjakan latihan kode.",
  "checkN": {
   "loop": "menggunakan perulangan",
  ...
  "teacherH": "Untuk guru dan penelitian",
  "runnerH": "Eksekusi kode",
  "infraH": "Saat ini tidak bisa dinilai.",
  "infra": {
   ...
   "worker": "Peramban ini tidak mengizinkan eksekusi JavaScript terisolasi. Coba peramban lain.",
  ...
  "aiOff": "Mati: game menggunakan petunjuk yang ditulis oleh penulis. Untuk menyalakannya, masukkan penyedia di bawah ini.",
  "provider": "Penyedia",
  "provAnthropic": "Anthropic (Claude)",
  "provOpenAI": "Kompatibel dengan OpenAI (OpenAI, Ollama, LM Studio, dll.)",
  "key": "Kunci API",
  ...
  "oops": [
   ...
   "Tidak kali ini, dan tidak apa-apa. Luangkan waktumu dengan penjelasannya."
  ],
  ...
  "homeI18n": "Game ini tersedia dalam 20 bahasa, sama seperti analisis terjemahan dan tokenisasi yang memandu proyek ini. Skrip kanan-ke-kiri didukung, dan bahasa dengan skripnya sendiri menawarkan versi romanisasi.",
  "aiDebug": "Minta bantuan tutor",
  "telLive": "Prosesmu sejauh ini: {p} tempel, {r} jalankan, {s} dtk.",
  "colPaste": "Tempel",
  "codeP": "Setiap pengiriman menyimpan skor, proses yang mengarah ke sana, dan sidik jari dari kode yang dikirim.",
  "xp": "XP",
  ...
  "arsenal": "Perlengkapan teori",
  "example": "Contoh kode",
  "aiLabel": "Tutor AI: ",
  "aiThinking": "Tutor sedang berpikir...",
  "bank": "Baris yang tersedia (ketuk untuk memakai)",
  "sol": "Programmu (ketuk baris untuk mengembalikan)",
  ...
  "bySkill": "Penguasaan berdasarkan keterampilan",
  "colSbc": "SBC",
  "recPriority": "Prioritas: {s} (penguasaan {p}, {c} benar dari {n}).",
  "recHints": "Petunjuk dipakai di {p} tiket. Coba bentuk hipotesis dulu sebelum bertanya.",
  "how": "Cara menghitung penguasaan",
  "howParams": "Parameter desain, belum dikalibrasi dengan data: tiket level 1, 2, dan 3 memiliki kesulitan -1,2, 0, dan +1,2 logit; perolehan awal 1,8, menyusut setiap jawaban, dengan kesalahan berbobot 70% untuk toleransi selip; menebak berdasarkan format (1 dari 4 untuk opsi, 1 per baris untuk bug, 1 dari 16 saat klasifikasi, 5% saat mengurutkan, 3% untuk jawaban diketik, dan 50% dengan petunjuk). Buka kunci pada 60%, penguasaan pada {m}, dikonfirmasi di hari lain. 3PL IRT, BKT, PFA, dan AFM hanya mengamati.",
  "dataP": "Progres hanya tersimpan di peramban ini. Log mengikuti format panjang dataset pelacakan pengetahuan (item, keterampilan, kebenaran, bahasa, bahasa pemrograman, stempel waktu).",
  ...
  "bossLoseP": "Kamu kehilangan {x} XP dari saldomu. Tinjau misi terkait dan kembali untuk tanding ulang.",
  "review": "Tinjau",
  "shopH": "Toko",
  ...
  "plH": "Penguasaan berdasarkan bahasa pemrograman",
  "rom": "Tampilkan teks romaji (alfabet Latin)",
  "pilotNote": "Satu model menjalankan permainan: ia menghitung penguasaan, membuka tahapan, dan menyesuaikan kesulitan. Model lain berjalan di latar belakang dan hanya mencatat prediksi mereka sebelum setiap jawaban, untuk perbandingan nanti. Persentase di samping setiap nama adalah ambang penguasaan model itu.",
  "roleShadow": "mengamati",
  "cmpP": "Sebelum setiap jawaban, lima model mencatat probabilitas respons benar yang mereka prediksi. Brier mengukur kesalahan prediksi (lebih rendah lebih baik); AUC mengukur apakah model memisahkan jawaban benar dari kesalahan (0,5 berarti kebetulan dan 1 sempurna).",
  "confirmNote": "Penguasaan tercapai hari ini. Untuk mengonfirmasi, jawab benar tiket keterampilan ini di hari lain: satu sesi mencampur pengetahuan dengan momentum.",
  ...
  "noExecH": "{l} tidak berjalan di dalam peramban.",
  "scored": "Skor: {p} ({b})",
  "colScore": "Skor",
  "colRuns": "Jalan",
  "colHash": "Sidik jari",
  "runnerNote": "Kode Java dan C siswa dikirim ke server itu untuk dikompilasi dan dijalankan. Jika kolom kosong, tidak ada yang keluar dari peramban.",
  "pilotFixed": "{m} menjalankan permainan: ia menghitung penguasaan, membuka tahapan, dan memilih kesulitan, dengan penguasaan dari {p}. BKT, PFA, AFM, dan 3PL IRT berjalan di latar belakang pada setiap jawaban dan hanya mencatat prediksi mereka, untuk perbandingan di tab Laporan dan di data yang diekspor."
 },
 "sbc": {
 ...
 "items": {
  ...
  "w1": {
   "title": "Ongkos kirim koperasi",
   "prompt": "Tulis fungsi ongkos kirim: 5 reais tetap ditambah 2 reais per kilometer.",
   "hint": "Satu baris saja cukup: kembalikan hasil perhitungan, jangan cetak.",
   "why": "Aturan itu menjadi fungsi bernama yang bisa dipanggil dari situs web, aplikasi, dan lembar kerja tanpa salinan yang berbeda.",
  ...
  "w2": {
   ...
   "prompt": "Tulis fungsi yang menjumlahkan semua nilai dalam daftar dan mengembalikan totalnya. Jika daftar kosong, totalnya nol.",
   "hint": "Mulai dengan akumulator nol dan telusuri daftar sambil menambahkan.",
   "why": "Ini adalah pola akumulator: nilai netral di awal, satu penambahan per putaran, hasilnya dikembalikan setelah perulangan.",
   "analogy": "Ini seperti celengan: mulai kosong, menerima koin satu per satu, dan hanya di akhir kamu menghitung isinya."
  },
  "w3": {
   "title": "Triase klinik",
   ...
   "hint": "Aturan paling serius didahulukan, dan setiap pasien keluar dengan satu tingkat.",
   "why": "Rangkaian kondisi menjamin satu hasil per pasien. Nilai batas, 39 dan 37,5, adalah tempat kesalahan sering muncul.",
   "analogy": "Ini seperti protokol di dinding klinik: baca dari atas ke bawah, berhenti di baris pertama yang sesuai."
  },
  "w4": {
   ...
   "hint": "Penghitung sebelum perulangan, kondisi di dalamnya, hasilnya sesudahnya.",
   "why": "Menghitung berbeda dari menjumlahkan: penghitung maju satu demi satu, tidak peduli seberapa besar nilainya. Lebih besar dari batas tidak termasuk nilai yang sama dengan batas.",
   "analogy": "Ini seperti penjaga pintu dengan kliker tangan: satu klik per orang yang memenuhi aturan."
  },
  "w5": {
   "title": "Faktorial, tanpa perulangan",
   "prompt": "Tulis fungsi faktorial menggunakan rekursi. Faktorial dari 0 adalah 1.",
   "hint": "Tangani kasus dasar terlebih dahulu; lalu kembalikan n kali faktorial dari n dikurangi 1.",
   "why": "Tanpa kasus dasar, fungsi akan memanggil dirinya sendiri selamanya. Dengan kasus dasar, setiap panggilan bergerak menuju nol dan jawabannya kembali dengan perkalian.",
   "analogy": "Ini seperti boneka Rusia: kamu berhenti di boneka padat dan kembali menutupnya satu per satu."
  },
  "w6": {
   "title": "Kembalian di toko roti",
   "prompt": "Tulis fungsi yang mengembalikan kembalian: berapa sisa dari jumlah yang dibayar setelah dikurangi harga.",
   "hint": "Satu pengurangan dan satu pengembalian. Harga dan pembayaran datang sebagai parameter.",
   "why": "Kedua nilai datang dari luar, fungsi mengembalikan hasil dan tidak mencetak apa pun: dengan begitu fungsi melayani mesin kasir, struk, dan laporan.",
   "analogy": "Ini seperti kalkulator di meja kasir: menerima dua angka, menunjukkan selisihnya, dan tidak menyimpan apa pun untuk dirinya sendiri."
  }
 },
 "game": {
  "shop": {
