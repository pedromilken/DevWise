...
LANG.tr = {
 ...
 "ui": {
  ...
  "locked": "Kilitli: {p} bölümünde %60'a ulaşınca açılır.",
  ...
  "bossRules": "Zincirleme üç aşama, ipucu ve güçlendirme yok. Tek bir hata yapabilirsin. Tahtada seçilen zorluk burada da geçerli.",
  "trophies": "Kupalar",
  "equip": "Bu unvanı kullan",
  "evoP": "Her satır, cevapladığın görevlerdeki bir becerinin tahmini ustalığını gösterir. Bir beceriye dokunarak onu vurgula: yeşil noktalar doğru cevapları, sarı noktalar hataları gösterir. Kesikli çizgiler açılmayı (%60) ve ustalığı ({m}) işaretler.",
  "models": {
   "elo": "Elo/Rasch",
   "irt": "EAP ile 3PL IRT",
   "bkt": "BKT",
  ...
  "homeLangs": "diller",
  "homePls": "programlama dilleri",
  "runErr": "Kod çalışmadı, bu yüzden puan 0: {e}",
  "hidden": "Gizli durumlar: {b} taneden {a} doğru. Bunlar, çözümün yalnızca görünür örnekler için değil gerçekten çalıştığından emin olmak için var.",
  "codeEmpty": "Henüz kod egzersizi cevaplanmadı.",
  "teacherP": "Teknik ayarlar. Oyuncuların burada hiçbir şeyi değiştirmesine gerek yok.",
  "runnerP": "JavaScript ve Python tarayıcının içinde çalışır. Java ve C, kodu derleyip çalıştıran bir sunucuya ihtiyaç duyar; böyle bir sunucu yoksa o dillerdeki kod egzersizleri gizli kalır. Kendi Piston sunucunu veya Şubat 2026'dan beri ticari olmayan eğitim projelerine verilen bir jeton gerektiren Piston'un genel API'sini kullan.",
  "start": "İlk sprinte başla",
  "sprint": "Sprint {n}",
  "todo": "Yapılacaklar",
  "doneSprint": "Bu sprintte yapılanlar",
  "map": "Ustalık haritası",
  "sbcH": "Burada çalışılan SBC Müfredat Yönergeleri (2017) yeterlilikleri",
  "check": "Cevabı kontrol et",
  "aiFail": "AI öğretmen yanıt vermedi. Ayarları kontrol et veya normal ipucunu kullan.",
  "allUsed": "Tüm satırlar kullanıldı.",
  "options": "Seçenekler",
  "codeLines": "Kod satırları",
  "delta": "{s} ustalığı: {a} → {b}   (+{x} XP)",
  "changed": "Ustalığında ne değişti",
  "k1": "cevaplanan görevler",
  "colHits": "Doğru",
  "recNone": "Henüz cevap yok. Öğretmenin kanıtı olması için birkaç görev çöz.",
  "howP": "Öğretmen bir Elo/Rasch modeli kullanır. Her becerinin bir puanı vardır ve her görevin aynı ölçekte bir zorluğu vardır. İkisi arasındaki fark, doğru cevap olasılığını verir; cevap verdikten sonra puan, sürprizle orantılı olarak yukarı veya aşağı hareket eder. Gösterilen ustalık, ortalama zorluktaki bir görevi tahmin etmeden çözme şansındır ve bir beceri {m} değerinden itibaren ustalaşmış sayılır.",
  "aiP": "AI öğretmen, cevabı vermeden oyun dilinde kişiye özel Sokratik ipuçları ve taze analojiler yazar. O olmadan oyun, yazarların yazdığı ipuçlarını kullanır.",
  "aiClaude": "Bu bağlantı üzerinden Claude ile bağlanıldı. GitHub'da yayınlanan sürümde, öğretmenin bir API anahtarına ihtiyacı vardır.",
  "none": "Hiçbiri",
  "titleLbl": "Başlık",
  "modeDesc": {
   "normal": "XP ×1. Ücretsiz ipuçları (ipucu ile doğru cevap yarım puan kazandırır). Her hata, görev seviyesi başına 2 XP'ye mal olur.",
   "medio": "XP ×1.5. Her ipucu 5 XP'ye mal olur. Her hata, görev seviyesi başına 4 XP'ye mal olur.",
   "dificil": "XP ×2. Çıktı görevlerinde ipucu ve seçenek yok: programın yazdırdığını sen yazarsın. Her hata, seviye başına 6 XP'ye mal olur.",
   "hardcore": "XP ×3. İpucu yok, cevapları yazarsın ve süre 60 saniyedir. Her hata, seviye başına 10 XP'ye mal olur."
  },
  "lost": "Ceza: Bakiyenden -{x} XP.",
  "useTime": "+30 sn kullan ({n})",
  "bossLives": "Kalan izin verilen hata: {n}",
  "shopP": "XP bakiyeni güçlendiriciler ve unvanlar için kullan. Bakiye harcamak, aşamaları ve boss'ları açan ömür boyu XP'yi azaltmaz.",
  "powers": "Güçlendiriciler",
  "buy": "{c} XP karşılığında al",
  "evoH": "Bilgi gelişimi",
  "plP": "Her dilin kendi ustalık takipçisi vardır; kullanılan ● ile işaretlenir. Bir dili ilk denediğinde, bir aktarım tahmininden başlarsın: en iyi dilinde kat edilen yolun yarısı. Kalın değerler pratik yapılmıştır.",
  "pilot": "Oyunu yönlendiren model",
  "rolePilot": "yönlendirir",
  "cmpNote": "Tek bir öğrenciden az cevap ile bu sayılar çok dalgalanır. Geçerli bir karşılaştırma, birçok öğrencinin dışa aktarılan kayıtlarını öğrenciye göre bölerek kullanır.",
  "colRole": "Rol",
  "confirmRule": "Ustalığın başka bir günde doğru cevapla teyit edilmesini iste",
  "homeMissions": "hikaye ve teori içeren görevler",
  "homeTickets": "bankadaki görevler",
  "submit": "Notlandırma için gönder",
  "noExecP": "Bu alıştırma yalnızca, bir öğretmenin Ayarlar > Öğretmenler ve araştırma için bölümünde kurduğu bir kod çalıştırma hizmeti ile notlandırılabilir. Bu arada, kod alıştırmalarını çözmek için Ayarlar'da Python veya JavaScript seç.",
  "checkN": {
   "loop": "bir döngü kullanır",
   "cond": "bir koşul kullanır",
   "rec": "kendini çağırır",
   "base": "bir temel duruma sahiptir",
   "return": "bir değer döndürür"
  },
  "aiStatusShort": "AI öğretmen:",
  "teacherH": "Öğretmenler ve araştırma için",
  "runnerH": "Kod çalıştırma",
  "infraH": "Şu anda notlandırılamadı.",
  "infra": {
   "semServico": "Bu dil için hiçbir çalıştırma hizmeti yapılandırılmadı.",
   "auth": "Çalıştırma hizmeti erişimi reddetti. Ayarlar'daki jetonu kontrol et.",
   "rede": "Çalıştırma hizmeti yanıt vermedi. Bağlantıyı kontrol edip tekrar dene.",
   "pyodide": "Python indirilemedi. İlk seferde internete ihtiyaç duyar; bağlantıyı kontrol edip tekrar dene.",
   "worker": "Bu tarayıcı izole JavaScript yürütmeye izin vermiyor. Başka bir tarayıcı dene.",
   "outro": "Çalıştırma hizmeti bir hata döndürdü. Bir dakika sonra tekrar dene."
  },
  "xp": "XP",
  "navSettings": "Ayarlar",
  ...
  "arsenal": "Teori araç çantası",
  "example": "Kod örneği",
  "aiLabel": "AI eğitmen: ",
  "aiThinking": "Eğitmen düşünüyor...",
  "bank": "Kullanılabilir satırlar (kullanmak için dokun)",
  "sol": "Senin programın (geri almak için bir satıra dokun)",
  "retroH": "Sprint {n} retrospektifi",
  "retroB": "İyi tempo; geride kalanları gözden geçir.",
  "colStart": "Sprint başlangıcı",
  "suggestion": "Eğitmenin bir sonraki sprint için önerisi: şu anda {p} ustalığında olan {s} konusuna odaklan.",
  "bySkill": "Beceriye göre ustalık",
  "colSbc": "SBC",
  "recPriority": "Öncelik: {s} ({p} ustalık, {n} sorudan {c} doğru).",
  "recHints": "Görevlerin %{p}'sinde ipucu kullanıldı. Sormadan önce bir hipotez oluşturmayı dene.",
  "how": "Ustalık nasıl hesaplanır",
  "howParams": "Tasarım parametreleri, henüz veriyle kalibre edilmedi: seviye 1, 2 ve 3 görevlerin zorluğu -1.2, 0 ve +1.2 logit; başlangıç kazancı 1.8, her cevapla azalır, hatalar %70 ağırlıkta tolerans için; formata göre tahmin (seçeneklerde 4'te 1, hata bulmada satır başına 1, sınıflandırmada 16'da 1, sıralamada %5, yazılı cevaplarda %3 ve ipucuyla %50). %60'ta açılır, ustalık {m}'de, başka bir gün teyit edilir. 3PL IRT, BKT, PFA ve AFM sadece gözlemler.",
  "dataP": "İlerleme yalnızca bu tarayıcıda kaydedilir. Günlük, bilgi izleme veri kümelerinin uzun formatını izler (öğe, beceri, doğruluk, dil, programlama dili, zaman damgası).",
  "hideJson": "JSON günlüğünü gizle",
  "download": "JSON'u indir",
  "aiH": "AI eğitmen",
  "aiKeyOn": "Kendi anahtarınla yapılandırıldı ({m}).",
  "typedLbl": "Programın yazdıracağını aynen yaz",
  "expected": "Doğru çıktı: {a}",
  "timeLeft": "Süre: {s} sn",
  "lockedXp": "Kilitli: {p} konusunda %60 ve {x} ömür boyu XP gerekiyor (sende {y} var).",
  "bossResult": "Sonucu gör",
  "bossLoseP": "Bakiyenden {x} XP kaybettin. İlgili görevleri gözden geçir ve rövanş için geri gel.",
  "review": "Gözden geçir",
  "shopH": "Mağaza",
  ...
  "cheers": [
   "Aferin!",
   "Harika kod okuma!",
   "İsabetli, keskin akıl yürütme!",
   "Görev şık bir şekilde kapatıldı!"
  ],
  "need": "{c} maliyetine {n} XP kaldı",
  "evoX": "cevaplanan görevler",
  "colFirst": "İlk tahmin",
  "plH": "Programlama diline göre ustalık",
  "rom": "Latin alfabesine çevrilmiş metni göster",
  "pilotNote": "Oyunu bir model yönlendirir: ustalığı hesaplar, aşamaları açar ve zorluğu ayarlar. Diğerleri arka planda çalışır ve her cevaptan önce tahmin ettikleri olasılıkları kaydeder, sonra karşılaştırmak için. Her ismin yanındaki yüzde o modelin ustalık eşiğidir.",
  "roleShadow": "gözlemler",
  "cmpP": "Her cevaptan önce beş model, doğru cevap olasılığını tahmin eder. Brier tahmin hatasını ölçer (düşük daha iyi); AUC modelin doğru cevapları hatalardan ayırıp ayırmadığını ölçer (0.5 şans, 1 mükemmeldir).",
  "confirmNote": "Bugün ustalığa ulaşıldı. Teyit etmek için bu beceriden bir görevi başka bir gün doğru cevapla: tek bir oturum bilgiyi momentumla karıştırır.",
  "stC": "Başka bir gün teyit edilecek",
  "repFor": "Öğrenci: {n}",
  "navHome": "Ana sayfa",
  "homeSciH": "Araç nasıl geliştirildi",
  "bands": [
   "Düzensiz",
   "Orta",
   "İyi",
  ...
  "noExecH": "{l} tarayıcı içinde çalışmaz.",
  "scored": "Puan: {p} ({b})",
  "colScore": "Puan",
  "colRuns": "Çalıştırma",
  "colHash": "Parmak izi",
  "runnerNote": "Öğrencilerin Java ve C kodu derlenip çalıştırılmak üzere o sunucuya gönderilir. Alan boşsa tarayıcıdan hiçbir şey çıkmaz.",
  "pilotFixed": "{m} oyunu yönlendirir: ustalığı hesaplar, aşamaları açar ve zorluğu seçer, ustalık {p}'den. BKT, PFA, AFM ve 3PL IRT her cevapta arka planda çalışır ve yalnızca tahminlerini kaydeder; Rapor sekmesinde ve dışa aktarılan veride karşılaştırma için.",
  ...
  "lockedAria": "kilitli",
  "aiHint": "Yapay zeka öğretmeninden ipucu iste",
  "tutorHint": "Öğretmenin ipucu: ",
  "solved": "Görev çözüldü",
  "promo": "Terfi: rolün artık {r}.",
  "aiExplain": "Yapay zeka öğretmeninden başka bir benzetme iste",
  ...
  "aiOff": "Kapalı: oyun, yazarların yazdığı ipuçlarını kullanır. Açmak için aşağıya bir sağlayıcı girin.",
  "provider": "Sağlayıcı",
  ...
  "noTrophies": "Henüz yok. Yeterli ustalık ve XP'n olduğunda patronlar panoda belirir.",
  "kTotal": "toplam XP",
  "oops": [
   "Neredeyse. Her geliştirici düzeltmeden önce derlemeyi bozar.",
   "Hatalar yolun bir parçası: artık tuzağın nerede olduğunu biliyorsun.",
   "Mantığında bir hata buldun, hata ayıklama böyle öğrenilir.",
   "Bu sefer olmadı, sorun değil. Açıklama için acele etme."
  ],
  "comeback": "Geri dön: Bir hatanın hemen ardından doğru yaparsan +{x} XP.",
  "evoEmpty": "Öğrenme eğrini görmek için bu dilde birkaç görev çöz.",
  "evoAll": "Tümü",
  "colGain": "Kazanç",
  "colModel": "Model",
  "colAcc": "Doğruluk",
  "printedOn": "Oluşturulma: {d}",
  "homeI18n": "Oyun 20 dilde mevcut; aynı diller projeyi yönlendiren çeviri ve belirteçleştirme analizinden geliyor. Sağdan sola yazılan diller desteklenir ve kendi alfabesi olan diller için Latin alfabesiyle bir sürüm sunulur.",
  "aiDebug": "Öğretmenden yardım iste",
  "telLive": "Şu ana kadarki sürecin: {p} yapıştırma, {r} çalıştırma, {s} sn.",
  "colPaste": "Yapıştırmalar",
  "codeP": "Her gönderim, puanı, ona götüren süreci ve gönderilen kodun parmak izini saklar.",
  "navReport": "Rapor",
  "homeLead": "Ponte'ye az önce katıldın; burası mahalledeki fırına, sağlık ocağına, okula ve dağıtım kooperatifine hizmet veren küçük bir yazılım atölyesi. Her müşteri gerçek bir sorunla gelir: hikâyeyi dinlersin, teori araç setini çalışırsın ve ancak ondan sonra görevleri üstlenirsin.",
  "steps": [
   [
    "Müşteriyi dinle",
    "Her görev, sorunu yaşayan insanların anlattığı gerçek bir sorunun hikâyesiyle başlar."
   ],
   [
    "Teori araç setini oluştur",
    "Ana kavramlar, seçtiğin dilde bir kod örneği ve çalışılan SBC müfredat yeterliliği."
   ],
   [
    "Görevleri çöz",
    "Çıktıları tahmin et, kodu sırala, hataları avla ve mühendislik kararları ver. Her cevap, pratik bir benzetmeyle birlikte gelir ve öğretmen, ustalığını izler."
   ]
  ],
  "toReview": "gözden geçirilecek",
  "areaProg": "Programlama",
  "mapHint": "Ayrıntıları görmek için bir beceriye dokun. Sayı, o beceriyi zaten edinmiş olma olasılığının tahminidir.",
  "and": " ve ",
  "story": "Hikâye",
  "snippetNote": "Java ve C parçacıkları, odak kavram üzerinde kalsın diye sınıf ve main fonksiyonunu dışarıda bırakır.",
  "startTickets": "Hazırım: bu görevin biletlerini serbest bırak",
  ...
  "diff": "Zorluk 3 üzerinden {d}",
  "hintNote": "İpucu ile doğru cevap, XP'nin yarısını kazandırır ve ustalığın daha zayıf kanıtı sayılır.",
  "up": "Yukarı taşı",
  "notYet": "Bu sefer olmadı",
  "roseNote": "Hata yapmana rağmen hafifçe yükseldi çünkü model, açıklamayı okumanın da öğrettiğini varsayar.",
  "toRetro": "Sprint retrospektifini gör",
  "retroSum": "{n} görevden {c} tanesi çözüldü. ",
  "colSkill": "Beceri",
  "allDone": "Tüm becerilerde ustalaştın. Sonraki sprintler serbest çalışmadır.",
  "nextSprint": "Sprint {n}'i başlat",
  "repSub": "Öğrenci ve onu destekleyenler için bir görünüm: nelerde ustalaşıldı, hatalar nerede ve sırada ne çalışılmalı.",
  "k2": "doğruluk",
  "stL": "Kilitli",
  "showJson": "JSON günlüğünü göster",
  "reset": "İlerlemeyi sil",
  "model": "Model",
  "modeH": "Zorluk",
  "yourAnswer": "Senin cevabın: {a}",
  "timeout": "Süre doldu.",
  "hintPaid": "İpucu iste (maliyeti {c} XP)",
  "noHints": "Bu modda ipucu yok.",
  "useFifty": "İki tanesini kaldır ({n})",
  "bountyDone": "Meydan okuma tamamlandı: {s} (+{x} XP)",
  "bossesH": "Patronlar",
  "bossLocked": "{p} alanında %60 ve {x} toplam XP gerekli.",
  "bossDefeated": "Yenildi",
  "bossFight": "Patronla yüzleş",
  "titlesH": "Unvanlar",
  "owned": "Sende var: {n}",
  "unequip": "Kullanmayı bırak",
  "sortHint": "Her kart için iki kategoriden birini seç.",
  "modelH": "Bilgi izleme modeli",
  "running": "Kodun çalıştırılıyor...",
  "gotExp": "{g} alındı, {e} bekleniyordu",
  "checks": "Yapı:",
  "telDone": "Bu gönderimin kaydı: {p} yapıştırma (en büyüğü {m} karakterli), {r} çalıştırma, toplam {s} saniye. Kod parmak izi: {h}",
  "runnerUrl": "Çalıştırma hizmeti adresi",
  "pilotUrl": "Araştırma modu açık: bu sayfanın adresi {m} modelini sürücü model olarak ayarlar. Varsayılana dönmek için ?piloto= parametresini kaldır.",
  "runnerOff": "Java ve C: çalıştırma yok. Bu dillerdeki kod alıştırmaları gizli kalır.",
  "navBoard": "Pano",
  "roles": [
   "Stajyer",
   "Kıdemsiz",
  ...
  "nothingDone": "Henüz bir şey yapılmadı. Sprint'i açmak için bir görev seç.",
  "areaSE": "Yazılım mühendisliği",
  "masteredTxt": "Uzmanlaşıldı. ",
  ...
  "hint": "İpucu iste",
  "analogy": "Benzetme: ",
  "masteredNow": "Beceri kazanıldı: {s}.",
  ...
  "recBloom": "En çok hata yapılan bilişsel düzey: {b} ({c} / {n}). İpucu kullanmadan sakin bir şekilde bu tür görevler üzerinde çalış.",
  "howA": "satranç puanı gibidir. Güçlü bir rakibi yenmek çok puan kazandırır, zayıf bir rakibi yenmek az puan kazandırır, zayıf bir rakibe yenilmek ise çok puan kaybettirir. Burada rakip görevdir.",
  "base": "Temel URL",
  "clear": "Anahtarı kaldır",
  "saved": "Ayarlar kaydedildi.",
  "keyNote": "Anahtar yalnızca bu tarayıcıda saklanır (localStorage) ve doğrudan sağlayıcıya gönderilir. Ortak kullanılan bir bilgisayarda kullanmayın. Sınıf kullanımı için, anahtar gerektirmeyen yerel bir sunucu tercih edin (örneğin, Ollama http://localhost:11434/v1).",
  "navShop": "Dükkan",
  ...
  "reward": "Ödül: {x} XP",
  "shopA": "sadakat programındaki miller gibidir. Bakiyeyi görevlerde harcarsınız; kart seviyeniz toplam uçulan mile bağlıdır ve ödül kullandığınızda düşmez.",
  "equipped": "Kullanımda",
  "keepGoing": "Bu görev daha sonra rövanş için panoya geri dönecek.",
  "streakMsg": "Art arda {n}! Seri bonusu: +5 XP.",
  "plA": "düz vites araba kullanan biri, otomatik viteste en baştan başlamaz, ama uyum sağladığını göstermek için mahallede birkaç tur atması gerekir.",
  "plAcc": "Doğru",
  "printBtn": "Yazdır veya PDF olarak kaydet",
  "homeSbc": "14 görev programlama ve yazılım mühendisliğini kapsar ve her biri SBC Müfredat Yönergeleri'nden (2017) hangi yeterlilikleri geliştirdiğini belirtir. Aynı kavram dört programlama dilinde, aynı cevap anahtarıyla sunulur.",
  "codeFn": "Fonksiyonu yaz: {f}. İsim tam olarak bu olmalı.",
  "runBtn": "Çalıştır",
  "codeH": "Serbest kod alıştırmaları",
  "codeAuth": "Bu neyi kanıtlar, neyi kanıtlamaz: parmak izi ve zaman damgası, kodun o anda gönderildiğini kanıtlar; yapıştırma sayısı ve süre süreci tanımlar. Hiçbiri yazarlığı kanıtlamaz, çünkü her şey öğrencinin kendi tarayıcısında kaydedilir. Notlu değerlendirme için, denetimli çalışma veya kodun kendisinin savunulması ekleyin.",
  "codeHidden": "{l} dilindeki serbest kod alıştırmaları, öğretmen bir çalıştırma servisi kurana kadar gizli kalır. Python ve JavaScript'te normal olarak görünür.",
  "runnerToken": "Yetkilendirme anahtarı (servis gerektiriyorsa)",
  "runnerOn": "Java ve C: çalıştırma açık.",
  "colTries": "Görevler",
  "colTime": "Süre"
 },
 "sbc": {
 ...
 "items": {
  ...
  "w1": {
   "title": "Kooperatifin kargo ücreti",
   "prompt": "Kargo fonksiyonunu yaz: 5 real sabit ücret artı kilometre başına 2 real.",
   "hint": "Tek satır yeterli: hesaplamanın sonucunu döndür, ekrana yazdırma.",
   "why": "Kural, web sitesinden, uygulamadan ve elektronik tablodan farklı kopyalar oluşmadan çağrılabilen adlandırılmış bir fonksiyon haline gelir.",
   "analogy": "Duvardaki fiyat listesidir: tek bir tane vardır ve herkes aynısını okur."
  },
  "w2": {
   "title": "Satış listesini toplamak",
   "prompt": "Bir listedeki tüm değerleri toplayıp toplamı döndüren fonksiyonu yaz. Liste boşsa toplam sıfırdır.",
   "hint": "Sıfırla başlayan bir biriktiriciyle başla ve listede dolaşarak topla.",
   "why": "Bu biriktirici desenidir: başlangıçta nötr bir değer, her turda bir toplama, döngüden sonra döndürülen sonuç.",
   "analogy": "Kumbaradır: boş başlar, her seferinde bir bozuk para alır ve içinde ne olduğunu sadece sonunda sayarsın."
  },
  "w3": {
   "title": "Klinik triyajı",
   "prompt": "Triyaj fonksiyonunu yaz: 39 veya üzeri \"kırmızı\" döndürür; 37,5 ile 38,9 arası \"sarı\" döndürür; 37,5 altı \"yeşil\" döndürür.",
   "hint": "En ciddi kural önce gelir ve her hasta tek bir seviyeyle ayrılır.",
   "why": "Koşullar zinciri, hasta başına tek bir sonucu garanti eder. Sınır değerleri olan 39 ve 37,5 hataların tam olarak ortaya çıktığı yerlerdir.",
   "analogy": "Klinik duvarındaki protokoldür: yukarıdan aşağıya okunur, geçerli olan ilk satırda durulur."
  },
  "w4": {
   "title": "Kaç tanesi limiti aşıyor",
   "prompt": "Listedeki değerlerden kaçının verilen limitten büyük olduğunu sayan fonksiyonu yaz.",
   "hint": "Döngüden önce bir sayaç, içinde bir koşul, sonrasında sonuç.",
   "why": "Saymak toplamaktan farklıdır: değer ne kadar büyük olursa olsun sayaç her seferinde bir artar. Limitten büyük olması, ona eşit olan değeri dışlar.",
   "analogy": "El sayacı olan kapı görevlisidir: kurala uyan her kişi için bir tık."
  },
  "w5": {
   "title": "Faktöriyel, döngüsüz",
   "prompt": "Özyineleme kullanarak faktöriyel fonksiyonunu yaz. 0'ın faktöriyeli 1'dir.",
   "hint": "Önce temel durumu ele al; sonra n çarpı n eksi 1'in faktöriyelini döndür.",
   "why": "Temel durum olmadan fonksiyon kendini sonsuza kadar çağırır. Onunla birlikte her çağrı sıfıra doğru ilerler ve cevaplar çarpılarak geri gelir.",
   "analogy": "Rus matruşkalarıdır: dolu olanda durursun ve onları tek tek kapatarak geri gelirsin."
  },
  "w6": {
   "title": "Fırın para üstü",
   "prompt": "Para üstünü döndüren fonksiyonu yaz: ödenen tutardan fiyat çıkarıldıktan sonra kalan miktar.",
   "hint": "Bir çıkarma ve bir döndürme. Fiyat ve ödenen parametre olarak gelir.",
   "why": "Her iki değer de dışarıdan gelir, fonksiyon sonucu döndürür ve hiçbir şey yazdırmaz: böylece kasaya, fişe ve rapora hizmet eder.",
   "analogy": "Tezgahtaki hesap makinesidir: iki sayıyı alır, farkı gösterir ve kendine hiçbir şey saklamaz."
  }
 },
 "game": {
  "shop": {
